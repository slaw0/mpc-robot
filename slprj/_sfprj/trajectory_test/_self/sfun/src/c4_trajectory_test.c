...
static void initialize_c4_trajectory_test(SFc4_trajectory_testInstanceStruct
  *chartInstance);
static void initialize_params_c4_trajectory_test
  (SFc4_trajectory_testInstanceStruct *chartInstance);
static void enable_c4_trajectory_test(SFc4_trajectory_testInstanceStruct
  *chartInstance);
static void disable_c4_trajectory_test(SFc4_trajectory_testInstanceStruct
  *chartInstance);
static void c4_update_debugger_state_c4_trajectory_test
  (SFc4_trajectory_testInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c4_trajectory_test
  (SFc4_trajectory_testInstanceStruct *chartInstance);
static void set_sim_state_c4_trajectory_test(SFc4_trajectory_testInstanceStruct *
  chartInstance, const mxArray *c4_st);
static void finalize_c4_trajectory_test(SFc4_trajectory_testInstanceStruct
  *chartInstance);
static void sf_c4_trajectory_test(SFc4_trajectory_testInstanceStruct
  *chartInstance);
static void c4_chartstep_c4_trajectory_test(SFc4_trajectory_testInstanceStruct
  *chartInstance);
static void initSimStructsc4_trajectory_test(SFc4_trajectory_testInstanceStruct *
  chartInstance);
static void init_script_number_translation(uint32_T c4_machineNumber, uint32_T
  c4_chartNumber);
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData);
static real_T c4_emlrt_marshallIn(SFc4_trajectory_testInstanceStruct
  *chartInstance, const mxArray *c4_qapp, const char_T *c4_identifier);
static real_T c4_b_emlrt_marshallIn(SFc4_trajectory_testInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static const mxArray *c4_b_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static void c4_c_emlrt_marshallIn(SFc4_trajectory_testInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId,
  real_T c4_y[3]);
...
static const mxArray *c4_c_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static void c4_d_emlrt_marshallIn(SFc4_trajectory_testInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId,
  real_T c4_y[18]);
static void c4_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static void c4_info_helper(c4_ResolvedFunctionInfo c4_info[16]);
static void c4_eml_scalar_eg(SFc4_trajectory_testInstanceStruct *chartInstance);
static real_T c4_mpower(SFc4_trajectory_testInstanceStruct *chartInstance,
  real_T c4_a);
static real_T c4_b_mpower(SFc4_trajectory_testInstanceStruct *chartInstance,
  real_T c4_a);
static real_T c4_c_mpower(SFc4_trajectory_testInstanceStruct *chartInstance,
  real_T c4_a);
static void c4_b_eml_scalar_eg(SFc4_trajectory_testInstanceStruct *chartInstance);
static const mxArray *c4_d_sf_marshallOut(void *chartInstanceVoid, void
  *c4_inData);
static int32_T c4_e_emlrt_marshallIn(SFc4_trajectory_testInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void c4_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c4_mxArrayInData, const char_T *c4_varName, void *c4_outData);
static uint8_T c4_f_emlrt_marshallIn(SFc4_trajectory_testInstanceStruct
  *chartInstance, const mxArray *c4_b_is_active_c4_trajectory_test, const char_T
  *c4_identifier);
static uint8_T c4_g_emlrt_marshallIn(SFc4_trajectory_testInstanceStruct
  *chartInstance, const mxArray *c4_u, const emlrtMsgIdentifier *c4_parentId);
static void init_dsm_address_info(SFc4_trajectory_testInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c4_is_active_c4_trajectory_test = 0U;
}
  ...
  (SFc4_trajectory_testInstanceStruct *chartInstance)
{
  ...
  c4_d_hoistedGlobal = chartInstance->c4_is_active_c4_trajectory_test;
  ...
  chartInstance, const mxArray *c4_st)
{
  ...
  *c4_qapp = c4_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c4_u,
    2)), "qapp");
  chartInstance->c4_is_active_c4_trajectory_test = c4_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c4_u, 3)),
     "is_active_c4_trajectory_test");
  sf_mex_destroy(&c4_u);
  c4_update_debugger_state_c4_trajectory_test(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c4_sfEvent = CALL_EVENT;
  c4_chartstep_c4_trajectory_test(chartInstance);
...
static const mxArray *c4_sf_marshallOut(void *chartInstanceVoid, void *c4_inData)
{
  ...
  const mxArray *c4_y = NULL;
  SFc4_trajectory_testInstanceStruct *chartInstance;
  chartInstance = (SFc4_trajectory_testInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c4_trajectory_test_get_eml_resolved_functions_info(void)
{
  ...
  *c4_identifier)
{
  ...
  c4_y = c4_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c4_b_is_active_c4_trajectory_test), &c4_thisId);
  sf_mex_destroy(&c4_b_is_active_c4_trajectory_test);
  return c4_y;
}
...
/* SFunction Glue Code */
void sf_c4_trajectory_test_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c4_trajectory_test_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c4_trajectory_test(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[11],T\"qa\",},{M[1],M[12],T\"qap\",},{M[1],M[13],T\"qapp\",},{M[8],M[0],T\"is_active_c4_trajectory_test\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c4_trajectory_test_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc4_trajectory_testInstanceStruct *chartInstance;
    chartInstance = (SFc4_trajectory_testInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c4_trajectory_test(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc4_trajectory_testInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c4_trajectory_test((SFc4_trajectory_testInstanceStruct*)
    chartInstanceVar);
  initialize_c4_trajectory_test((SFc4_trajectory_testInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c4_trajectory_test(void *chartInstanceVar)
{
  enable_c4_trajectory_test((SFc4_trajectory_testInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c4_trajectory_test(void *chartInstanceVar)
{
  disable_c4_trajectory_test((SFc4_trajectory_testInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c4_trajectory_test(void *chartInstanceVar)
{
  sf_c4_trajectory_test((SFc4_trajectory_testInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c4_trajectory_test(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c4_trajectory_test
    ((SFc4_trajectory_testInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c4_trajectory_test();/* state var info */
...
extern void sf_internal_set_sim_state_c4_trajectory_test(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c4_trajectory_test((SFc4_trajectory_testInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c4_trajectory_test(SimStruct* S)
{
  return sf_internal_get_sim_state_c4_trajectory_test(S);
}

static void sf_opaque_set_sim_state_c4_trajectory_test(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c4_trajectory_test(S, st);
}

static void sf_opaque_terminate_c4_trajectory_test(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc4_trajectory_testInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c4_trajectory_test((SFc4_trajectory_testInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc4_trajectory_test((SFc4_trajectory_testInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c4_trajectory_test(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c4_trajectory_test(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c4_trajectory_test(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c4_trajectory_test(SimStruct *S)
{
  SFc4_trajectory_testInstanceStruct *chartInstance;
  chartInstance = (SFc4_trajectory_testInstanceStruct *)malloc(sizeof
    (SFc4_trajectory_testInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc4_trajectory_testInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c4_trajectory_test;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c4_trajectory_test;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c4_trajectory_test;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c4_trajectory_test;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c4_trajectory_test;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c4_trajectory_test;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c4_trajectory_test;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c4_trajectory_test;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c4_trajectory_test;
  chartInstance->chartInfo.mdlStart = mdlStart_c4_trajectory_test;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c4_trajectory_test;
...
void c4_trajectory_test_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c4_trajectory_test(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_trajectory_test(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_trajectory_test(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c4_trajectory_test_method_dispatcher.\n"
