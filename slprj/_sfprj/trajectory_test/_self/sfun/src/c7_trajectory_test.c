...
static void initialize_c7_trajectory_test(SFc7_trajectory_testInstanceStruct
  *chartInstance);
static void initialize_params_c7_trajectory_test
  (SFc7_trajectory_testInstanceStruct *chartInstance);
static void enable_c7_trajectory_test(SFc7_trajectory_testInstanceStruct
  *chartInstance);
static void disable_c7_trajectory_test(SFc7_trajectory_testInstanceStruct
  *chartInstance);
static void c7_update_debugger_state_c7_trajectory_test
  (SFc7_trajectory_testInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c7_trajectory_test
  (SFc7_trajectory_testInstanceStruct *chartInstance);
static void set_sim_state_c7_trajectory_test(SFc7_trajectory_testInstanceStruct *
  chartInstance, const mxArray *c7_st);
static void finalize_c7_trajectory_test(SFc7_trajectory_testInstanceStruct
  *chartInstance);
static void sf_c7_trajectory_test(SFc7_trajectory_testInstanceStruct
  *chartInstance);
static void c7_chartstep_c7_trajectory_test(SFc7_trajectory_testInstanceStruct
  *chartInstance);
static void initSimStructsc7_trajectory_test(SFc7_trajectory_testInstanceStruct *
  chartInstance);
static void init_script_number_translation(uint32_T c7_machineNumber, uint32_T
  c7_chartNumber);
static const mxArray *c7_sf_marshallOut(void *chartInstanceVoid, void *c7_inData);
static real_T c7_emlrt_marshallIn(SFc7_trajectory_testInstanceStruct
  *chartInstance, const mxArray *c7_a5, const char_T *c7_identifier);
static real_T c7_b_emlrt_marshallIn(SFc7_trajectory_testInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
static void c7_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c7_mxArrayInData, const char_T *c7_varName, void *c7_outData);
static const mxArray *c7_b_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static void c7_c_emlrt_marshallIn(SFc7_trajectory_testInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId,
  real_T c7_y[6]);
...
static const mxArray *c7_c_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static void c7_d_emlrt_marshallIn(SFc7_trajectory_testInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId,
  real_T c7_y[36]);
...
static void c7_eml_scalar_eg(SFc7_trajectory_testInstanceStruct *chartInstance);
static real_T c7_mpower(SFc7_trajectory_testInstanceStruct *chartInstance,
  real_T c7_a);
static real_T c7_b_mpower(SFc7_trajectory_testInstanceStruct *chartInstance,
  real_T c7_a);
static real_T c7_c_mpower(SFc7_trajectory_testInstanceStruct *chartInstance,
  real_T c7_a);
static void c7_invNxN(SFc7_trajectory_testInstanceStruct *chartInstance, real_T
                      c7_x[36], real_T c7_y[36]);
static void c7_realmin(SFc7_trajectory_testInstanceStruct *chartInstance);
static void c7_eps(SFc7_trajectory_testInstanceStruct *chartInstance);
static void c7_eml_matlab_zgetrf(SFc7_trajectory_testInstanceStruct
  *chartInstance, real_T c7_A[36], real_T c7_b_A[36], int32_T c7_ipiv[6],
  int32_T *c7_info);
static void c7_eml_int_forloop_overflow_check(SFc7_trajectory_testInstanceStruct
  *chartInstance);
static void c7_b_eml_int_forloop_overflow_check
  (SFc7_trajectory_testInstanceStruct *chartInstance, int32_T c7_b);
static void c7_c_eml_int_forloop_overflow_check
  (SFc7_trajectory_testInstanceStruct *chartInstance);
static void c7_d_eml_int_forloop_overflow_check
  (SFc7_trajectory_testInstanceStruct *chartInstance, int32_T c7_a, int32_T c7_b);
static void c7_eml_xgeru(SFc7_trajectory_testInstanceStruct *chartInstance,
  int32_T c7_m, int32_T c7_n, real_T c7_alpha1, int32_T c7_ix0, int32_T c7_iy0,
  real_T c7_A[36], int32_T c7_ia0, real_T c7_b_A[36]);
static void c7_eml_xtrsm(SFc7_trajectory_testInstanceStruct *chartInstance,
  real_T c7_A[36], real_T c7_B[36], real_T c7_b_B[36]);
static void c7_e_eml_int_forloop_overflow_check
  (SFc7_trajectory_testInstanceStruct *chartInstance);
static real_T c7_norm(SFc7_trajectory_testInstanceStruct *chartInstance, real_T
                      c7_x[36]);
static void c7_eml_warning(SFc7_trajectory_testInstanceStruct *chartInstance);
static void c7_b_eml_warning(SFc7_trajectory_testInstanceStruct *chartInstance,
  char_T c7_varargin_2[14]);
static void c7_b_eml_scalar_eg(SFc7_trajectory_testInstanceStruct *chartInstance);
static void c7_e_emlrt_marshallIn(SFc7_trajectory_testInstanceStruct
  *chartInstance, const mxArray *c7_sprintf, const char_T *c7_identifier, char_T
  c7_y[14]);
static void c7_f_emlrt_marshallIn(SFc7_trajectory_testInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId,
  char_T c7_y[14]);
static const mxArray *c7_d_sf_marshallOut(void *chartInstanceVoid, void
  *c7_inData);
static int32_T c7_g_emlrt_marshallIn(SFc7_trajectory_testInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
static void c7_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c7_mxArrayInData, const char_T *c7_varName, void *c7_outData);
static uint8_T c7_h_emlrt_marshallIn(SFc7_trajectory_testInstanceStruct
  *chartInstance, const mxArray *c7_b_is_active_c7_trajectory_test, const char_T
  *c7_identifier);
static uint8_T c7_i_emlrt_marshallIn(SFc7_trajectory_testInstanceStruct
  *chartInstance, const mxArray *c7_u, const emlrtMsgIdentifier *c7_parentId);
static void c7_b_eml_matlab_zgetrf(SFc7_trajectory_testInstanceStruct
  *chartInstance, real_T c7_A[36], int32_T c7_ipiv[6], int32_T *c7_info);
static void c7_b_eml_xgeru(SFc7_trajectory_testInstanceStruct *chartInstance,
  int32_T c7_m, int32_T c7_n, real_T c7_alpha1, int32_T c7_ix0, int32_T c7_iy0,
  real_T c7_A[36], int32_T c7_ia0);
static void c7_b_eml_xtrsm(SFc7_trajectory_testInstanceStruct *chartInstance,
  real_T c7_A[36], real_T c7_B[36]);
static void init_dsm_address_info(SFc7_trajectory_testInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c7_is_active_c7_trajectory_test = 0U;
}
  ...
  (SFc7_trajectory_testInstanceStruct *chartInstance)
{
  ...
  c7_g_hoistedGlobal = chartInstance->c7_is_active_c7_trajectory_test;
  ...
  chartInstance, const mxArray *c7_st)
{
  ...
  *c7_a5 = c7_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c7_u, 5)),
    "a5");
  chartInstance->c7_is_active_c7_trajectory_test = c7_h_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c7_u, 6)),
     "is_active_c7_trajectory_test");
  sf_mex_destroy(&c7_u);
  c7_update_debugger_state_c7_trajectory_test(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c7_sfEvent = CALL_EVENT;
  c7_chartstep_c7_trajectory_test(chartInstance);
...
static const mxArray *c7_sf_marshallOut(void *chartInstanceVoid, void *c7_inData)
{
  ...
  const mxArray *c7_y = NULL;
  SFc7_trajectory_testInstanceStruct *chartInstance;
  chartInstance = (SFc7_trajectory_testInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c7_trajectory_test_get_eml_resolved_functions_info(void)
{
  ...
  *c7_identifier)
{
  ...
  c7_y = c7_i_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c7_b_is_active_c7_trajectory_test), &c7_thisId);
  sf_mex_destroy(&c7_b_is_active_c7_trajectory_test);
  return c7_y;
}
...
/* SFunction Glue Code */
void sf_c7_trajectory_test_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c7_trajectory_test_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c7_trajectory_test(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x7'type','srcId','name','auxInfo'{{M[1],M[7],T\"a0\",},{M[1],M[8],T\"a1\",},{M[1],M[9],T\"a2\",},{M[1],M[10],T\"a3\",},{M[1],M[11],T\"a4\",},{M[1],M[12],T\"a5\",},{M[8],M[0],T\"is_active_c7_trajectory_test\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 7, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c7_trajectory_test_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc7_trajectory_testInstanceStruct *chartInstance;
    chartInstance = (SFc7_trajectory_testInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c7_trajectory_test(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc7_trajectory_testInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c7_trajectory_test((SFc7_trajectory_testInstanceStruct*)
    chartInstanceVar);
  initialize_c7_trajectory_test((SFc7_trajectory_testInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c7_trajectory_test(void *chartInstanceVar)
{
  enable_c7_trajectory_test((SFc7_trajectory_testInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c7_trajectory_test(void *chartInstanceVar)
{
  disable_c7_trajectory_test((SFc7_trajectory_testInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c7_trajectory_test(void *chartInstanceVar)
{
  sf_c7_trajectory_test((SFc7_trajectory_testInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c7_trajectory_test(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c7_trajectory_test
    ((SFc7_trajectory_testInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c7_trajectory_test();/* state var info */
...
extern void sf_internal_set_sim_state_c7_trajectory_test(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c7_trajectory_test((SFc7_trajectory_testInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c7_trajectory_test(SimStruct* S)
{
  return sf_internal_get_sim_state_c7_trajectory_test(S);
}

static void sf_opaque_set_sim_state_c7_trajectory_test(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c7_trajectory_test(S, st);
}

static void sf_opaque_terminate_c7_trajectory_test(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc7_trajectory_testInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c7_trajectory_test((SFc7_trajectory_testInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc7_trajectory_test((SFc7_trajectory_testInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c7_trajectory_test(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c7_trajectory_test(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c7_trajectory_test(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c7_trajectory_test(SimStruct *S)
{
  SFc7_trajectory_testInstanceStruct *chartInstance;
  chartInstance = (SFc7_trajectory_testInstanceStruct *)malloc(sizeof
    (SFc7_trajectory_testInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc7_trajectory_testInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c7_trajectory_test;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c7_trajectory_test;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c7_trajectory_test;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c7_trajectory_test;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c7_trajectory_test;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c7_trajectory_test;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c7_trajectory_test;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c7_trajectory_test;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c7_trajectory_test;
  chartInstance->chartInfo.mdlStart = mdlStart_c7_trajectory_test;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c7_trajectory_test;
...
void c7_trajectory_test_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c7_trajectory_test(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c7_trajectory_test(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c7_trajectory_test(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c7_trajectory_test_method_dispatcher.\n"
