...
static void initialize_c8_trajectory_test(SFc8_trajectory_testInstanceStruct
  *chartInstance);
static void initialize_params_c8_trajectory_test
  (SFc8_trajectory_testInstanceStruct *chartInstance);
static void enable_c8_trajectory_test(SFc8_trajectory_testInstanceStruct
  *chartInstance);
static void disable_c8_trajectory_test(SFc8_trajectory_testInstanceStruct
  *chartInstance);
static void c8_update_debugger_state_c8_trajectory_test
  (SFc8_trajectory_testInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c8_trajectory_test
  (SFc8_trajectory_testInstanceStruct *chartInstance);
static void set_sim_state_c8_trajectory_test(SFc8_trajectory_testInstanceStruct *
  chartInstance, const mxArray *c8_st);
static void finalize_c8_trajectory_test(SFc8_trajectory_testInstanceStruct
  *chartInstance);
static void sf_c8_trajectory_test(SFc8_trajectory_testInstanceStruct
  *chartInstance);
static void c8_chartstep_c8_trajectory_test(SFc8_trajectory_testInstanceStruct
  *chartInstance);
static void initSimStructsc8_trajectory_test(SFc8_trajectory_testInstanceStruct *
  chartInstance);
static void init_script_number_translation(uint32_T c8_machineNumber, uint32_T
  c8_chartNumber);
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData);
static real_T c8_emlrt_marshallIn(SFc8_trajectory_testInstanceStruct
  *chartInstance, const mxArray *c8_a5, const char_T *c8_identifier);
static real_T c8_b_emlrt_marshallIn(SFc8_trajectory_testInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static const mxArray *c8_b_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static void c8_c_emlrt_marshallIn(SFc8_trajectory_testInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId,
  real_T c8_y[6]);
...
static const mxArray *c8_c_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static void c8_d_emlrt_marshallIn(SFc8_trajectory_testInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId,
  real_T c8_y[36]);
...
static void c8_eml_scalar_eg(SFc8_trajectory_testInstanceStruct *chartInstance);
static real_T c8_mpower(SFc8_trajectory_testInstanceStruct *chartInstance,
  real_T c8_a);
static real_T c8_b_mpower(SFc8_trajectory_testInstanceStruct *chartInstance,
  real_T c8_a);
static real_T c8_c_mpower(SFc8_trajectory_testInstanceStruct *chartInstance,
  real_T c8_a);
static void c8_invNxN(SFc8_trajectory_testInstanceStruct *chartInstance, real_T
                      c8_x[36], real_T c8_y[36]);
static void c8_realmin(SFc8_trajectory_testInstanceStruct *chartInstance);
static void c8_eps(SFc8_trajectory_testInstanceStruct *chartInstance);
static void c8_eml_matlab_zgetrf(SFc8_trajectory_testInstanceStruct
  *chartInstance, real_T c8_A[36], real_T c8_b_A[36], int32_T c8_ipiv[6],
  int32_T *c8_info);
static void c8_eml_int_forloop_overflow_check(SFc8_trajectory_testInstanceStruct
  *chartInstance);
static void c8_b_eml_int_forloop_overflow_check
  (SFc8_trajectory_testInstanceStruct *chartInstance, int32_T c8_b);
static void c8_c_eml_int_forloop_overflow_check
  (SFc8_trajectory_testInstanceStruct *chartInstance);
static void c8_d_eml_int_forloop_overflow_check
  (SFc8_trajectory_testInstanceStruct *chartInstance, int32_T c8_a, int32_T c8_b);
static void c8_eml_xgeru(SFc8_trajectory_testInstanceStruct *chartInstance,
  int32_T c8_m, int32_T c8_n, real_T c8_alpha1, int32_T c8_ix0, int32_T c8_iy0,
  real_T c8_A[36], int32_T c8_ia0, real_T c8_b_A[36]);
static void c8_eml_xtrsm(SFc8_trajectory_testInstanceStruct *chartInstance,
  real_T c8_A[36], real_T c8_B[36], real_T c8_b_B[36]);
static void c8_e_eml_int_forloop_overflow_check
  (SFc8_trajectory_testInstanceStruct *chartInstance);
static real_T c8_norm(SFc8_trajectory_testInstanceStruct *chartInstance, real_T
                      c8_x[36]);
static void c8_eml_warning(SFc8_trajectory_testInstanceStruct *chartInstance);
static void c8_b_eml_warning(SFc8_trajectory_testInstanceStruct *chartInstance,
  char_T c8_varargin_2[14]);
static void c8_b_eml_scalar_eg(SFc8_trajectory_testInstanceStruct *chartInstance);
static void c8_e_emlrt_marshallIn(SFc8_trajectory_testInstanceStruct
  *chartInstance, const mxArray *c8_sprintf, const char_T *c8_identifier, char_T
  c8_y[14]);
static void c8_f_emlrt_marshallIn(SFc8_trajectory_testInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId,
  char_T c8_y[14]);
static const mxArray *c8_d_sf_marshallOut(void *chartInstanceVoid, void
  *c8_inData);
static int32_T c8_g_emlrt_marshallIn(SFc8_trajectory_testInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c8_mxArrayInData, const char_T *c8_varName, void *c8_outData);
static uint8_T c8_h_emlrt_marshallIn(SFc8_trajectory_testInstanceStruct
  *chartInstance, const mxArray *c8_b_is_active_c8_trajectory_test, const char_T
  *c8_identifier);
static uint8_T c8_i_emlrt_marshallIn(SFc8_trajectory_testInstanceStruct
  *chartInstance, const mxArray *c8_u, const emlrtMsgIdentifier *c8_parentId);
static void c8_b_eml_matlab_zgetrf(SFc8_trajectory_testInstanceStruct
  *chartInstance, real_T c8_A[36], int32_T c8_ipiv[6], int32_T *c8_info);
static void c8_b_eml_xgeru(SFc8_trajectory_testInstanceStruct *chartInstance,
  int32_T c8_m, int32_T c8_n, real_T c8_alpha1, int32_T c8_ix0, int32_T c8_iy0,
  real_T c8_A[36], int32_T c8_ia0);
static void c8_b_eml_xtrsm(SFc8_trajectory_testInstanceStruct *chartInstance,
  real_T c8_A[36], real_T c8_B[36]);
static void init_dsm_address_info(SFc8_trajectory_testInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c8_is_active_c8_trajectory_test = 0U;
}
  ...
  (SFc8_trajectory_testInstanceStruct *chartInstance)
{
  ...
  c8_g_hoistedGlobal = chartInstance->c8_is_active_c8_trajectory_test;
  ...
  chartInstance, const mxArray *c8_st)
{
  ...
  *c8_a5 = c8_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c8_u, 5)),
    "a5");
  chartInstance->c8_is_active_c8_trajectory_test = c8_h_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c8_u, 6)),
     "is_active_c8_trajectory_test");
  sf_mex_destroy(&c8_u);
  c8_update_debugger_state_c8_trajectory_test(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c8_sfEvent = CALL_EVENT;
  c8_chartstep_c8_trajectory_test(chartInstance);
...
static const mxArray *c8_sf_marshallOut(void *chartInstanceVoid, void *c8_inData)
{
  ...
  const mxArray *c8_y = NULL;
  SFc8_trajectory_testInstanceStruct *chartInstance;
  chartInstance = (SFc8_trajectory_testInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c8_trajectory_test_get_eml_resolved_functions_info(void)
{
  ...
  *c8_identifier)
{
  ...
  c8_y = c8_i_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c8_b_is_active_c8_trajectory_test), &c8_thisId);
  sf_mex_destroy(&c8_b_is_active_c8_trajectory_test);
  return c8_y;
}
...
/* SFunction Glue Code */
void sf_c8_trajectory_test_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c8_trajectory_test_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c8_trajectory_test(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x7'type','srcId','name','auxInfo'{{M[1],M[7],T\"a0\",},{M[1],M[8],T\"a1\",},{M[1],M[9],T\"a2\",},{M[1],M[10],T\"a3\",},{M[1],M[11],T\"a4\",},{M[1],M[12],T\"a5\",},{M[8],M[0],T\"is_active_c8_trajectory_test\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 7, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c8_trajectory_test_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc8_trajectory_testInstanceStruct *chartInstance;
    chartInstance = (SFc8_trajectory_testInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c8_trajectory_test(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc8_trajectory_testInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c8_trajectory_test((SFc8_trajectory_testInstanceStruct*)
    chartInstanceVar);
  initialize_c8_trajectory_test((SFc8_trajectory_testInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c8_trajectory_test(void *chartInstanceVar)
{
  enable_c8_trajectory_test((SFc8_trajectory_testInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c8_trajectory_test(void *chartInstanceVar)
{
  disable_c8_trajectory_test((SFc8_trajectory_testInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c8_trajectory_test(void *chartInstanceVar)
{
  sf_c8_trajectory_test((SFc8_trajectory_testInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c8_trajectory_test(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c8_trajectory_test
    ((SFc8_trajectory_testInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c8_trajectory_test();/* state var info */
...
extern void sf_internal_set_sim_state_c8_trajectory_test(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c8_trajectory_test((SFc8_trajectory_testInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c8_trajectory_test(SimStruct* S)
{
  return sf_internal_get_sim_state_c8_trajectory_test(S);
}

static void sf_opaque_set_sim_state_c8_trajectory_test(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c8_trajectory_test(S, st);
}

static void sf_opaque_terminate_c8_trajectory_test(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc8_trajectory_testInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c8_trajectory_test((SFc8_trajectory_testInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc8_trajectory_test((SFc8_trajectory_testInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c8_trajectory_test(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c8_trajectory_test(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c8_trajectory_test(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c8_trajectory_test(SimStruct *S)
{
  SFc8_trajectory_testInstanceStruct *chartInstance;
  chartInstance = (SFc8_trajectory_testInstanceStruct *)malloc(sizeof
    (SFc8_trajectory_testInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc8_trajectory_testInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c8_trajectory_test;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c8_trajectory_test;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c8_trajectory_test;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c8_trajectory_test;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c8_trajectory_test;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c8_trajectory_test;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c8_trajectory_test;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c8_trajectory_test;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c8_trajectory_test;
  chartInstance->chartInfo.mdlStart = mdlStart_c8_trajectory_test;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c8_trajectory_test;
...
void c8_trajectory_test_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c8_trajectory_test(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c8_trajectory_test(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c8_trajectory_test(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c8_trajectory_test_method_dispatcher.\n"
