 ...
 const mxArray * prhs[] )
{
  ...
  if(sf_trajectory_test_process_check_sum_call(nlhs,plhs,nrhs,prhs)) return 1;
  return 0;
}
 ...
 nrhs, const mxArray * prhs[] )
{
  ...
  if(sf_trajectory_test_autoinheritance_info(nlhs,plhs,nrhs,prhs)) return 1;
  return 0;
}
...
extern unsigned int sf_trajectory_test_method_dispatcher(SimStruct *S, const
 char *chartName, int_T method, void *data);
unsigned int sf_machine_global_method_dispatcher(SimStruct *simstructPtr, const
 char *chartName, int_T method, void *data)
{
  if(sf_trajectory_test_method_dispatcher(simstructPtr,chartName,method,data))
  return 1;
  return 0;
}
