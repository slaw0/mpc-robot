...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
 const mxArray * prhs[] )
{
  extern unsigned int sf_invgeo_test_process_check_sum_call( int nlhs, mxArray *
   plhs[], int nrhs, const mxArray * prhs[] );

  if(sf_invgeo_test_process_check_sum_call(nlhs,plhs,nrhs,prhs)) return 1;
  return 0;
}
unsigned int sf_process_autoinheritence_call( int nlhs, mxArray * plhs[], int
 nrhs, const mxArray * prhs[] )
{
  extern unsigned int sf_invgeo_test_autoinheritance_info( int nlhs, mxArray *
   plhs[], int nrhs, const mxArray * prhs[] );
  if(sf_invgeo_test_autoinheritance_info(nlhs,plhs,nrhs,prhs)) return 1;
  return 0;
}
...
extern unsigned int sf_invgeo_test_method_dispatcher(SimStruct *S, const char
...
{
  if(sf_invgeo_test_method_dispatcher(simstructPtr,chartName,method,data))
  return 1;
  return 0;
}
extern void invgeo_test_terminator(void);
void sf_machine_global_terminator(void)
{
  if(sfMachineGlobalTerminatorCallable) {
    ...
    invgeo_test_terminator();
    sf_debug_terminate();
  }
  return;
}
extern void invgeo_test_initializer(void);
extern void invgeo_test_register_exported_symbols(SimStruct* S);
extern void invgeo_test_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  invgeo_test_register_exported_symbols(S);
}
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if(sfMachineGlobalInitializerCallable) {
    ...
    if(!simModeIsRTWGen) {
      invgeo_test_debug_initialize();
    }
    invgeo_test_initializer();
  }
  return;
}
