...
static void initialize_c1_MPC_framework(void)
{
  ...
  *c1_init_out_enable() = 1U;
  _SFD_DATA_RANGE_CHECK((real_T)*c1_init_out_enable(), 1U);
  _SFD_CC_CALL(EXIT_OUT_OF_FUNCTION_TAG,0);
...
static void sf_c1_MPC_framework(void)
{
  ...
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance.c1_init_1_message, 18U);
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance.c1_init_2_message, 17U);
  ...
  _SFD_DATA_RANGE_CHECK((real_T)*c1_invgeo_done(), 6U);
  c1_previousEvent = _sfEvent_;
  _sfEvent_ = CALL_EVENT;
  c1_c1_MPC_framework();
  _sfEvent_ = c1_previousEvent;
      ...
      if(c1__bool_s32_(CV_TRANSITION_EVAL(18U,
        ...
        *c1_da_out_trigger() = 1.0;
        _SFD_DATA_RANGE_CHECK(*c1_da_out_trigger(), 4U);
         ...
         (int32_T)_SFD_CCP_CALL(3,0,((*c1_async_request() == 2.0)!=0)))) != 0) {
        if(sf_debug_transition_conflict_check_enabled()) {
        ...
        *c1_controller_message() = MAX_uint8_T;
        ...
        c1_enter_internal_CONTROLLER();
         ...
         (int32_T)_SFD_CCP_CALL(6,0,((*c1_async_request() == 6.0)!=0)))) != 0) {
...
static void c1_STOPPED(void)
{
  ...
  if(c1__bool_s32_(CV_TRANSITION_EVAL(21U,
     (int32_T)_SFD_CCP_CALL(21,0,((*c1_primitive_button() == 4)!=0)))) != 0) {
    if(sf_debug_transition_conflict_check_enabled()) {
    ...
    *c1_da_out_trigger() = 1.0;
    _SFD_DATA_RANGE_CHECK(*c1_da_out_trigger(), 4U);
     ...
     (int32_T)_SFD_CCP_CALL(9,0,((*c1_primitive_button() == 3)!=0)))) != 0) {
    if(sf_debug_transition_conflict_check_enabled()) {
      unsigned int transitionList[3];
      unsigned int numTransitions=1;
      transitionList[0] = 9;
    ...
    *c1_da_out_trigger() = 1.0;
    _SFD_DATA_RANGE_CHECK(*c1_da_out_trigger(), 4U);
     ...
     (int32_T)_SFD_CCP_CALL(26,0,((*c1_primitive_button() == 2)!=0)))) != 0) {
    if(sf_debug_transition_conflict_check_enabled()) {
      unsigned int transitionList[2];
      unsigned int numTransitions=1;
      transitionList[0] = 26;
...
static void c1_PRIMITIVE(void)
{
  ...
  if(c1__bool_s32_(CV_TRANSITION_EVAL(30U,
     (int32_T)_SFD_CCP_CALL(30,0,((*c1_async_request() == 2.0)!=0)))) != 0) {
    if(sf_debug_transition_conflict_check_enabled()) {
      unsigned int transitionList[3];
      unsigned int numTransitions=1;
      transitionList[0] = 30;
    ...
    c1_enter_internal_CONTROLLER();
     ...
     (int32_T)_SFD_CCP_CALL(8,0,((*c1_async_request() == 8.0)!=0)))) != 0) {
    if(sf_debug_transition_conflict_check_enabled()) {
      unsigned int transitionList[2];
      unsigned int numTransitions=1;
      transitionList[0] = 8;
    ...
    switch(chartInstance.c1_is_PRIMITIVE) {
     case c1_IN_MOVING:
      ...
      if(c1__bool_s32_(CV_TRANSITION_EVAL(31U,
         (int32_T)_SFD_CCP_CALL(31,0,((*c1_primitive_button() == 5)!=0)))) != 0)
      {
...
static void c1_CONTROLLER(void)
{
  ...
  if(c1__bool_s32_(CV_TRANSITION_EVAL(12U,
     (int32_T)_SFD_CCP_CALL(12,0,((*c1_async_request() == 1.0)!=0)))) != 0) {
    if(sf_debug_transition_conflict_check_enabled()) {
      unsigned int transitionList[3];
      unsigned int numTransitions=1;
      transitionList[0] = 12;
    ...
    *c1_da_out_trigger() = 1.0;
    _SFD_DATA_RANGE_CHECK(*c1_da_out_trigger(), 4U);
     ...
     (int32_T)_SFD_CCP_CALL(5,0,((*c1_async_request() == 8.0)!=0)))) != 0) {
    if(sf_debug_transition_conflict_check_enabled()) {
      unsigned int transitionList[2];
      unsigned int numTransitions=1;
      transitionList[0] = 5;
    ...
    *c1_operation_mode() = 4U;
    _SFD_DATA_RANGE_CHECK((real_T)*c1_operation_mode(), 11U);
     ...
     (int32_T)_SFD_CCP_CALL(15,0,((*c1_async_request() == 6.0)!=0)))) != 0) {
    ...
    switch(chartInstance.c1_is_CONTROLLER) {
      ...
      *c1_motor2_reference() = chartInstance.c1_alpha2_ref;
      ...
      if(c1__bool_s32_(CV_TRANSITION_EVAL(2U,
         (int32_T)_SFD_CCP_CALL(2,0,((*c1_invgeo_done() == 1)!=0)))) != 0) {
        _SFD_CT_CALL(TRANSITION_ACTIVE_TAG,2);
        if(c1__bool_s32_(CV_TRANSITION_EVAL(16U,
           (int32_T)_SFD_CCP_CALL(16,0,((c1_get_invgeo_error(0) == 0)!=0)))) !=
         0) {
          if(sf_debug_transition_conflict_check_enabled()) {
            unsigned int transitionList[2];
            unsigned int numTransitions=1;
          ...
          *c1_controller_message() = 1U;
          ...
          sf_mex_call("disp", 0U, 1U, 6, (real_T)c1_b_controller_message);
           ...
           (int32_T)_SFD_CCP_CALL(27,0,((c1_get_invgeo_error(0) == 1)!=0)))) !=
         0) {
  ...
  if(c1__bool_s32_(CV_TRANSITION_EVAL(0U,
    ...
    *c1_da_out_trigger() = 1.0;
    _SFD_DATA_RANGE_CHECK(*c1_da_out_trigger(), 4U);
     ...
     (int32_T)_SFD_CCP_CALL(33,0,((*c1_async_request() == 2.0)!=0)))) != 0) {
    if(sf_debug_transition_conflict_check_enabled()) {
    ...
    *c1_operation_mode() = 4U;
    _SFD_DATA_RANGE_CHECK((real_T)*c1_operation_mode(), 11U);
     ...
     (int32_T)_SFD_CCP_CALL(29,0,((*c1_async_request() == 7.0)!=0)))) != 0) {
    if(sf_debug_transition_conflict_check_enabled()) {
      unsigned int transitionList[4];
      unsigned int numTransitions=1;
      transitionList[0] = 29;
    ...
    *c1_operation_mode() = 3U;
    _SFD_DATA_RANGE_CHECK((real_T)*c1_operation_mode(), 11U);
     ...
     (int32_T)_SFD_CCP_CALL(1,0,((*c1_async_request() == 5.0)!=0)))) != 0) {
    if(sf_debug_transition_conflict_check_enabled()) {
      unsigned int transitionList[3];
      unsigned int numTransitions=1;
      transitionList[0] = 1;
    ...
    *c1_operation_mode() = 3U;
    _SFD_DATA_RANGE_CHECK((real_T)*c1_operation_mode(), 11U);
     ...
     (int32_T)_SFD_CCP_CALL(32,0,((*c1_async_request() == 4.0)!=0)))) != 0) {
    if(sf_debug_transition_conflict_check_enabled()) {
      unsigned int transitionList[2];
      unsigned int numTransitions=1;
      transitionList[0] = 32;
    ...
    *c1_operation_mode() = 3U;
    _SFD_DATA_RANGE_CHECK((real_T)*c1_operation_mode(), 11U);
     ...
     (int32_T)_SFD_CCP_CALL(4,0,((*c1_async_request() == 3.0)!=0)))) != 0) {
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3643675823U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3781306039U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2091855354U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(859730550U);
}
...
mxArray *sf_c1_MPC_framework_get_autoinheritance_info(void)
{
  ...
  mxCreateStructMatrix(1,1,4,autoinheritanceFields);
  {
    ...
    pr[0] = (double)(2591049438U);
    pr[1] = (double)(1236830047U);
    pr[2] = (double)(257973621U);
    pr[3] = (double)(2155607991U);
    ...
    if(!sim_mode_is_rtw_gen(S)) {
      {
        ...
        if(chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(1,2,0,1,SF_UINT8,0,NULL,0,0,0,0.0,1.0,0,"init_out_enable",0);
          ...
          _SFD_SET_DATA_PROPS(18,10,0,0,SF_UINT8,0,NULL,1,0,8,0,1,0,"init_1_message",0);
          _SFD_SET_DATA_PROPS(17,10,0,0,SF_UINT8,0,NULL,1,0,8,0,1,0,"init_2_message",0);
          ...
          _SFD_SET_DATA_PROPS(2,11,0,0,SF_UINT8,0,NULL,0,0,0,0.0,1.0,0,"invgeo_error",0);
          _SFD_SET_DATA_PROPS(6,1,1,0,SF_UINT8,0,NULL,0,0,0,0.0,1.0,0,"invgeo_done",0);
          ...
          _SFD_ST_SUBSTATE_INDEX(6,1,12);
          _SFD_ST_SUBSTATE_INDEX(6,2,4);
          _SFD_ST_SUBSTATE_INDEX(6,3,15);
          _SFD_ST_SUBSTATE_COUNT(9,0);
          _SFD_ST_SUBSTATE_COUNT(12,0);
          _SFD_ST_SUBSTATE_COUNT(4,2);
          _SFD_ST_SUBSTATE_INDEX(4,0,10);
          _SFD_ST_SUBSTATE_INDEX(4,1,13);
          _SFD_ST_SUBSTATE_COUNT(10,1);
          _SFD_ST_SUBSTATE_INDEX(10,0,1);
          _SFD_ST_SUBSTATE_COUNT(1,0);
          _SFD_ST_SUBSTATE_COUNT(13,0);
          _SFD_ST_SUBSTATE_COUNT(15,2);
          _SFD_ST_SUBSTATE_INDEX(15,0,3);
          _SFD_ST_SUBSTATE_INDEX(15,1,14);
          _SFD_ST_SUBSTATE_COUNT(3,2);
          _SFD_ST_SUBSTATE_INDEX(3,0,0);
          _SFD_ST_SUBSTATE_INDEX(3,1,11);
          _SFD_ST_SUBSTATE_COUNT(0,2);
          _SFD_ST_SUBSTATE_INDEX(0,0,7);
          _SFD_ST_SUBSTATE_INDEX(0,1,17);
          _SFD_ST_SUBSTATE_COUNT(7,0);
          _SFD_ST_SUBSTATE_COUNT(17,0);
          _SFD_ST_SUBSTATE_COUNT(11,2);
          _SFD_ST_SUBSTATE_INDEX(11,0,2);
          _SFD_ST_SUBSTATE_INDEX(11,1,5);
        ...
        {
          _SFD_CV_INIT_STATE(10,1,0,0,0,0,NULL,NULL);
        }
        {
        ...
        _SFD_SET_DATA_VALUE_PTR(1U, c1_init_out_enable());
        ...
        _SFD_SET_DATA_VALUE_PTR(18U, &chartInstance.c1_init_1_message);
        _SFD_SET_DATA_VALUE_PTR(17U, &chartInstance.c1_init_2_message);
        ...
        _SFD_SET_DATA_VALUE_PTR(2U, chartInstance.c1_invgeo_error_address);
        _SFD_SET_DATA_VALUE_PTR(6U, c1_invgeo_done());
      }
    }
  } else {
...
static void mdlSetWorkWidths_c1_MPC_framework(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(478084753U));
  ssSetChecksum1(S,(2526347479U));
  ssSetChecksum2(S,(159813766U));
  ssSetChecksum3(S,(2961916175U));
