...
static SFc3_MPC_frameworkInstanceStruct chartInstance;

/* Function Declarations */
static void initialize_c3_MPC_framework(void);
static void initialize_params_c3_MPC_framework(void);
static void enable_c3_MPC_framework(void);
static void disable_c3_MPC_framework(void);
static void finalize_c3_MPC_framework(void);
...
static real32_T *c3_a0(void);
static real32_T *c3_a1(void);
static real32_T *c3_a2(void);
static real32_T *c3_a3(void);
static real32_T *c3_a4(void);
static real32_T *c3_a5(void);
static real_T *c3_t_sim(void);
static real32_T *c3_qa(void);
static real32_T *c3_qap(void);
static real32_T *c3_qapp(void);
static real_T *c3_t_end(void);
static void init_dsm_address_info(void);
static void sf_save_state_c3_MPC_framework(FILE *c3_file);
static void sf_load_state_c3_MPC_framework(FILE *c3_file);

/* Function Definitions */
static void initialize_c3_MPC_framework(void)
{
  _sfTime_ = (real_T)ssGetT(chartInstance.S);
  chartInstance.c3_is_active_c3_MPC_framework = 0U;
}
...
static void sf_save_state_c3_MPC_framework(FILE *c3_file)
{
  fwrite(&chartInstance.c3_is_active_c3_MPC_framework, 1,
   sizeof(chartInstance.c3_is_active_c3_MPC_framework), c3_file);
}

static void sf_load_state_c3_MPC_framework(FILE *c3_file)
{
  fread(&chartInstance.c3_is_active_c3_MPC_framework, 1,
   sizeof(chartInstance.c3_is_active_c3_MPC_framework), c3_file);
}

/* SFunction Glue Code */
void sf_c3_MPC_framework_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(2348650867U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(915088044U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(4239049218U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(3480757U);
}
    ...
    if(!sim_mode_is_rtw_gen(S)) {
      {
        ...
        if(chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(3,1,1,0,SF_SINGLE,0,NULL,0,0,0,0.0,1.0,0,"a0",0);
          _SFD_SET_DATA_PROPS(9,1,1,0,SF_SINGLE,0,NULL,0,0,0,0.0,1.0,0,"a1",0);
          _SFD_SET_DATA_PROPS(1,1,1,0,SF_SINGLE,0,NULL,0,0,0,0.0,1.0,0,"a2",0);
          _SFD_SET_DATA_PROPS(8,1,1,0,SF_SINGLE,0,NULL,0,0,0,0.0,1.0,0,"a3",0);
          _SFD_SET_DATA_PROPS(0,1,1,0,SF_SINGLE,0,NULL,0,0,0,0.0,1.0,0,"a4",0);
          _SFD_SET_DATA_PROPS(6,1,1,0,SF_SINGLE,0,NULL,0,0,0,0.0,1.0,0,"a5",0);
          _SFD_SET_DATA_PROPS(4,1,1,0,SF_DOUBLE,0,NULL,0,0,0,0.0,1.0,0,"t_sim",0);
          _SFD_SET_DATA_PROPS(2,2,0,1,SF_SINGLE,0,NULL,0,0,0,0.0,1.0,0,"qa",0);
          _SFD_SET_DATA_PROPS(10,2,0,1,SF_SINGLE,0,NULL,0,0,0,0.0,1.0,0,"qap",0);
          _SFD_SET_DATA_PROPS(7,2,0,1,SF_SINGLE,0,NULL,0,0,0,0.0,1.0,0,"qapp",0);
        ...
        _SFD_SET_DATA_VALUE_PTR(3U, c3_a0());
        _SFD_SET_DATA_VALUE_PTR(9U, c3_a1());
        _SFD_SET_DATA_VALUE_PTR(1U, c3_a2());
        _SFD_SET_DATA_VALUE_PTR(8U, c3_a3());
        _SFD_SET_DATA_VALUE_PTR(0U, c3_a4());
        _SFD_SET_DATA_VALUE_PTR(6U, c3_a5());
        _SFD_SET_DATA_VALUE_PTR(4U, c3_t_sim());
        _SFD_SET_DATA_VALUE_PTR(2U, c3_qa());
        _SFD_SET_DATA_VALUE_PTR(10U, c3_qap());
        _SFD_SET_DATA_VALUE_PTR(7U, c3_qapp());
...
static void sf_opaque_initialize_c3_MPC_framework(void *chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S);
  initialize_params_c3_MPC_framework();
  initialize_c3_MPC_framework();
}

static void sf_opaque_enable_c3_MPC_framework(void *chartInstanceVar)
{
  enable_c3_MPC_framework();
}

static void sf_opaque_disable_c3_MPC_framework(void *chartInstanceVar)
{
  disable_c3_MPC_framework();
}

static void sf_opaque_gateway_c3_MPC_framework(void *chartInstanceVar)
{
  sf_c3_MPC_framework();
}

static void sf_opaque_terminate_c3_MPC_framework(void *chartInstanceVar)
{
  finalize_c3_MPC_framework();
}

static void mdlProcessParameters_c3_MPC_framework(SimStruct *S)
{
  int i;
...
static void mdlRTW_c3_MPC_framework(SimStruct *S)
{
  if(sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "MPC_framework", 3);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void sf_save_debug_c3_MPC_framework(SFc3_MPC_frameworkInstanceStruct*
...
static void sf_load_debug_c3_MPC_framework(SFc3_MPC_frameworkInstanceStruct*
 chartInstance,FILE* file)
{
  int machineNumber = _MPC_frameworkMachineNumber_;
  int chartNumber = chartInstance->chartNumber;
...
static void sf_c3_MPC_framework_sim_ctx_io(SimStruct* S, const char io, FILE*
 file)
{
  if(io == 'r') {
    sf_load_state_c3_MPC_framework(file);
    sf_load_debug_c3_MPC_framework(&chartInstance, file);
  } else {
    sf_save_state_c3_MPC_framework(file);
    sf_save_debug_c3_MPC_framework(&chartInstance, file);
  }
}
...
void c3_MPC_framework_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_MPC_framework(S);
    break;
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_MPC_framework(S);
    break;
   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_MPC_framework(S);
    break;
   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
     "Error calling c3_MPC_framework_method_dispatcher.\n"
