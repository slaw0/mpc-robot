...
static void sf_c8_MPC_framework(void)
{
  ...
  for(c8_em_i13 = 0; c8_em_i13 < 6; c8_em_i13 = c8_em_i13 + 1) {
    ...
    for(c8_em_i14 = 0; c8_em_i14 < 6; c8_em_i14 = c8_em_i14 + 1) {
      c8_Ao[c8_em_i13] = c8_Ao[c8_em_i13] + c8_s_y[c8_em_i14][c8_em_i13] *
        c8_k_B[c8_em_i14];
    }
  }
...
static void c8_invNxN(real_T *c8_x, real_T *c8_y)
{
  ...
  for(c8_em_i15 = 0; c8_em_i15 < 6; c8_em_i15 = c8_em_i15 + 1) {
    for(c8_em_i16 = 0; c8_em_i16 < 6; c8_em_i16 = c8_em_i16 + 1) {
      c8_y[6 * c8_em_i15 + c8_em_i16] = 0.0;
      c8_b_A[c8_em_i15][c8_em_i16] = c8_x[6 * c8_em_i15 + c8_em_i16];
      c8_c_A[c8_em_i15][c8_em_i16] = c8_b_A[c8_em_i15][c8_em_i16];
    }
  }
  for(c8_em_i17 = 0; c8_em_i17 < 6; c8_em_i17 = c8_em_i17 + 1) {
    c8_pivot[c8_em_i17][0] = 1.0 + (real_T)c8_em_i17;
  }
  ...
  c8_g_y = rtInf;
  for(c8_em_i23 = 0; c8_em_i23 < 36; c8_em_i23 = c8_em_i23 + 1) {
    (*(real_T (*)[36])c8_y)[c8_em_i23] = c8_g_y;
  }
}
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(3581624112U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3057791786U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(3193941938U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(154680815U);
}
