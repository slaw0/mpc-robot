 ...
 plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if(nrhs>1 && mxIsChar(prhs[1])) {
    ...
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1072266670U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(4022777503U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1315211458U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1811975861U);
  }
  return 1;
#else
  return 0;
