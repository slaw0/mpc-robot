    ...
    switch(MPC_framework_DWork.StateMachine.is_PRIMITIVE) {
     case MPC_framework_IN_MOVING:
      if(MPC_framework_B.CANMessageUnpackingCANdb_l == 5) {
        ...
        MPC_framework_B.motor1_reference = (real_T)MPC_framework_P.SFunction_p7;
        MPC_framework_B.motor2_reference = (real_T)MPC_framework_P.SFunction_p7;
        MPC_framework_B.da_out_trigger = 1.0;
      } else {
        ...
        switch(MPC_framework_DWork.StateMachine.is_SEGMENT_2) {
         ...
         default:
          MPC_framework_DWork.StateMachine.is_SEGMENT_2 =
            (uint8_T)MPC_framework_IN_POSITIVE_MOV;
          MPC_framework_B.motor2_reference =
            (real_T)MPC_framework_P.SFunction_p6;
          MPC_framework_B.da_out_trigger = 1.0;
          break;
        }
      }
     ...
     case MPC_framework_IN_STOPPED:
      if(MPC_framework_B.CANMessageUnpackingCANdb_l == 4) {
        ...
        MPC_framework_DWork.StateMachine.is_SEGMENT_2 =
          (uint8_T)MPC_framework_IN_POSITIVE_MOV;
        MPC_framework_B.motor2_reference = (real_T)MPC_framework_P.SFunction_p6;
        MPC_framework_B.da_out_trigger = 1.0;
       ...
       case MPC_framework_IN_BLUETOOTH:
        if(MPC_framework_B.CANMessageUnpackingCANdb_d == 1.0) {
          ...
          MPC_framework_DWork.StateMachine.is_PRIMITIVE =
            (uint8_T)MPC_framework_IN_STOPPED;
          MPC_framework_B.motor1_reference =
            (real_T)MPC_framework_P.SFunction_p7;
          MPC_framework_B.motor2_reference =
            (real_T)MPC_framework_P.SFunction_p7;
          MPC_framework_B.da_out_trigger = 1.0;
        ...
        if(MPC_framework_B.CANMessageUnpackingCANdb_d == 1.0) {
          ...
          switch(MPC_framework_DWork.StateMachine.is_CONTROLLER) {
           ...
           case MPC_framework_IN_TRAJECTORY:
            if((_sfEvent_MPC_framework_ == CALL_EVENT) &&
             (MPC_framework_DWork.StateMachine.temporalCounter_i1 ==
              (uint32_T)MPC_framework_P.SFunction_p8)) {
              MPC_framework_B.motor1_reference =
                MPC_framework_DWork.invgeo_alpha_1;
              MPC_framework_B.motor2_reference =
                MPC_framework_DWork.invgeo_alpha_2;
...
void MPC_framework_step0(void)          /* Sample time: [0.01s, 0.0s] */
{
  ...
  /* Memory: '<S47>/Hidden_Mem_for_Latch_at_inp_port_2_of_Init' */
  ...
  /* Memory: '<S47>/Hidden_Mem_for_Latch_at_inp_port_4_of_Init' */
...

  {
    ...
    if(MPC_framework_P.Constant1_Value == 0.0) {
      rtb_MathFunction = rtb_Sum;
    } else if(MPC_framework_P.Constant1_Value <=
     floor(MPC_framework_P.Constant1_Value)) {
      rtb_MathFunction = rtb_Sum - floor(rtb_Sum /
        MPC_framework_P.Constant1_Value) * MPC_framework_P.Constant1_Value;
    } else {
      rtb_MathFunction = rtb_Sum / MPC_framework_P.Constant1_Value;
      uDivRound = floor(fabs(rtb_MathFunction) + 0.5);
      if(rtb_MathFunction < 0.0) {
        uDivRound = -uDivRound;
      }
      if(fabs(rtb_MathFunction - uDivRound) <= fabs(rtb_MathFunction) *
       DBL_EPSILON) {
        rtb_MathFunction = 0.0;
      } else {
        rtb_MathFunction = (rtb_MathFunction - floor(rtb_MathFunction)) *
     ...
     *  Product: '<S12>/Divide'
     */
    MPC_framework_B.Gain = rtb_MathFunction / MPC_framework_P.Constant1_Value *
      MPC_framework_P.Gain_Gain;

    /* Sum: '<S12>/Sum1' incorporates:
     *  Constant: '<S12>/Constant'
     */
    rtb_Sum1 = MPC_framework_B.CANMessageUnpackingCANdb_c -
      MPC_framework_P.Constant_Value;
     ...
     */
    if(MPC_framework_P.Constant1_Value == 0.0) {
      rtb_MathFunction = rtb_Sum1;
    } else if(MPC_framework_P.Constant1_Value <=
     floor(MPC_framework_P.Constant1_Value)) {
      rtb_MathFunction = rtb_Sum1 - floor(rtb_Sum1 /
        MPC_framework_P.Constant1_Value) * MPC_framework_P.Constant1_Value;
    } else {
      rtb_MathFunction = rtb_Sum1 / MPC_framework_P.Constant1_Value;
      uDivRound = floor(fabs(rtb_MathFunction) + 0.5);
      if(rtb_MathFunction < 0.0) {
        uDivRound = -uDivRound;
      }
     ...
     *  Product: '<S12>/Divide1'
     */
    MPC_framework_B.Gain1 = rtb_MathFunction / MPC_framework_P.Constant1_Value *
...

  {
    ...
    if(MPC_framework_DWork.Controller_MODE == SUBSYS_ENABLED) {
       ...
       *  Sum: '<S2>/Sum'
       */
      rtb_Product_o0 = (rtb_Switch1_idx - MPC_framework_B.Gain) *
       ...
       */
      rtb_Divide_d = (rtb_Product_o0 * MPC_framework_P.T_Value +
       ...
       */
      rtb_Divide_c = (rtb_Divide_d - MPC_framework_DWork.UnitDelay_DSTATE_e) *
        MPC_framework_P.Td1_Value / MPC_framework_P.T_Value;

      /* Product: '<S23>/Product' incorporates:
       *  Sum: '<S2>/Sum1'
       */
      rtb_Switch1_idx = (rtb_Switch1_idx_a - MPC_framework_B.Gain1) *
       ...
       *  Sum: '<S2>/Sum2'
       */
      MPC_framework_B.Gain_n = ((rt_SATURATE(rtb_Product_o0,
         ...
         MPC_framework_P.Saturation1_UpperSat)) + MPC_framework_P.c1_Value) *
      MPC_framework_P.Gain_Gain_b;
       ...
       *  Sum: '<S2>/Sum3'
       */
      MPC_framework_B.Gain1_i = ((rt_SATURATE(rtb_Switch1_idx,
         ...
         MPC_framework_P.Saturation1_UpperSat_i)) * MPC_framework_P.Gain2_Gain +
       MPC_framework_P.c2_Value) * MPC_framework_P.Gain1_Gain_k;

      /* Update for UnitDelay: '<S25>/Unit Delay' */
      MPC_framework_DWork.UnitDelay_DSTATE = rtb_Divide_d;

      /* Update for UnitDelay: '<S24>/Unit Delay' */
      MPC_framework_DWork.UnitDelay_DSTATE_e = rtb_Divide_d;
    ...
    if(MPC_framework_B.controller_enable > MPC_framework_P.Switch_Threshold) {
      MPC_framework_B.Switch[0] = MPC_framework_B.Gain_n;
      MPC_framework_B.Switch[1] = MPC_framework_B.Gain1_i;
    } else {
  ...
  if(MPC_framework_DWork.incremental_out_valuesender_MO == SUBSYS_ENABLED) {
...

    {
      ...
      tmp = fmod(floor(rtb_Sum), 65536.0);
      if(tmp < 0.0) {
        tmp += 65536.0;
      }
      ...
      tmp = fmod(floor(rtb_Sum1), 65536.0);
      if(tmp < 0.0) {
        tmp += 65536.0;
      }
  ...
  /* Update for Memory: '<S47>/Hidden_Mem_for_Latch_at_inp_port_2_of_Init' */
  MPC_framework_DWork.Hidden_Mem_for_Latch_at_inp_por =
    MPC_framework_B.motor1_reference;

  /* Update for Memory: '<S47>/Hidden_Mem_for_Latch_at_inp_port_4_of_Init' */
...
void MPC_framework_initialize(boolean_T firstTime)
{
  if (firstTime) {
...

    {
      ...
      pVoidBlockIORegion = (void *)(&MPC_framework_B.Gain);
      for (i = 0; i < 4; i++) {
    ...
    {
      int_T i;
      real_T *dwork_ptr = (real_T *) &MPC_framework_DWork.UnitDelay_DSTATE;
  ...
  /* InitializeConditions for Memory: '<S47>/Hidden_Mem_for_Latch_at_inp_port_2_of_Init' */
  MPC_framework_DWork.Hidden_Mem_for_Latch_at_inp_por =
    MPC_framework_P.Hidden_Mem_for_Latch_at_in;

  /* InitializeConditions for Memory: '<S47>/Hidden_Mem_for_Latch_at_inp_port_4_of_Init' */
  MPC_framework_DWork.Hidden_Mem_for_Latch_at_inp_p_l =
