...
static void sf_c1_MPC_framework(void)
{
  ...
  _SFD_DATA_RANGE_CHECK((real_T)*c1_init_ack_async(), 21U);
  _SFD_DATA_RANGE_CHECK((real_T)*c1_init_out_trigger(), 28U);
  _SFD_DATA_RANGE_CHECK((real_T)*c1_stop_trigger(), 20U);
  ...
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance.c1_init_1_message, 30U);
  _SFD_DATA_RANGE_CHECK((real_T)chartInstance.c1_init_2_message, 1U);
  ...
  _SFD_DATA_RANGE_CHECK(chartInstance.c1_alpha2_ref, 14U);
  ...
  _SFD_DATA_RANGE_CHECK((real_T)*c1_invgeo_done(), 8U);
  _SFD_DATA_RANGE_CHECK((real_T)*c1_trajectory_enable(), 31U);
  _SFD_DATA_RANGE_CHECK(chartInstance.c1_trajectory_time, 22U);
  ...
  switch(chartInstance.c1_is_c1_MPC_framework) {
   case c1_IN_INIT:
    ...
    if(c1__bool_s32_(CV_TRANSITION_EVAL(1U,
       (_SFD_CCP_CALL(1,0,((*c1_init_ack_sync() == 1)!=0)) != 0) &&
       (_SFD_CCP_CALL(1,1,((*
    ...
    switch(chartInstance.c1_is_OPERATION) {
     case c1_IN_BLUETOOTH:
      ...
      if(c1__bool_s32_(CV_TRANSITION_EVAL(10U,
         (int32_T)_SFD_CCP_CALL(10,0,((*c1_async_request() == 1.0)!=0)))) != 0) {
        ...
        *c1_da_out_trigger() = 1.0;
        ...
        c1_enter_internal_CONTROLLER();
         ...
         (int32_T)_SFD_CCP_CALL(33,0,((*c1_async_request() == 6.0)!=0)))) != 0) {
...
static void c1_STOPPED(void)
{
  ...
  if(c1__bool_s32_(CV_TRANSITION_EVAL(34U,
    ...
    *c1_motor1_reference() = (real_T)chartInstance.c1_motor_positive_value_seg_1;
    _SFD_DATA_RANGE_CHECK(*c1_motor1_reference(), 27U);
    *c1_da_out_trigger() = 1.0;
    _SFD_DATA_RANGE_CHECK(*c1_da_out_trigger(), 6U);
    ...
    *c1_motor2_reference() = (real_T)chartInstance.c1_motor_negative_value_seg_2;
    _SFD_DATA_RANGE_CHECK(*c1_motor2_reference(), 18U);
    *c1_da_out_trigger() = 1.0;
    _SFD_DATA_RANGE_CHECK(*c1_da_out_trigger(), 6U);
  } else if(c1__bool_s32_(CV_TRANSITION_EVAL(29U,
     (int32_T)_SFD_CCP_CALL(29,0,((*c1_primitive_button() == 3)!=0)))) != 0) {
    if(sf_debug_transition_conflict_check_enabled()) {
      unsigned int transitionList[3];
      unsigned int numTransitions=1;
      transitionList[0] = 29;
    ...
    *c1_motor1_reference() = (real_T)chartInstance.c1_motor_negative_value_seg_1;
    _SFD_DATA_RANGE_CHECK(*c1_motor1_reference(), 27U);
    *c1_da_out_trigger() = 1.0;
    _SFD_DATA_RANGE_CHECK(*c1_da_out_trigger(), 6U);
    chartInstance.c1_is_active_SEGMENT_2 = 1U;
    ...
    *c1_motor2_reference() = (real_T)chartInstance.c1_motor_positive_value_seg_2;
    _SFD_DATA_RANGE_CHECK(*c1_motor2_reference(), 18U);
    *c1_da_out_trigger() = 1.0;
    _SFD_DATA_RANGE_CHECK(*c1_da_out_trigger(), 6U);
  } else if(c1__bool_s32_(CV_TRANSITION_EVAL(11U,
     (int32_T)_SFD_CCP_CALL(11,0,((*c1_primitive_button() == 2)!=0)))) != 0) {
    if(sf_debug_transition_conflict_check_enabled()) {
      unsigned int transitionList[2];
      unsigned int numTransitions=1;
      transitionList[0] = 11;
    ...
    *c1_da_out_trigger() = 1.0;
    _SFD_DATA_RANGE_CHECK(*c1_da_out_trigger(), 6U);
     ...
     (int32_T)_SFD_CCP_CALL(26,0,((*c1_primitive_button() == 1)!=0)))) != 0) {
...
static void c1_PRIMITIVE(void)
{
  ...
  if(c1__bool_s32_(CV_TRANSITION_EVAL(15U,
     (int32_T)_SFD_CCP_CALL(15,0,((*c1_async_request() == 2.0)!=0)))) != 0) {
    if(sf_debug_transition_conflict_check_enabled()) {
      unsigned int transitionList[3];
      unsigned int numTransitions=1;
      transitionList[0] = 15;
    ...
    c1_enter_internal_CONTROLLER();
     ...
     (int32_T)_SFD_CCP_CALL(2,0,((*c1_async_request() == 8.0)!=0)))) != 0) {
    if(sf_debug_transition_conflict_check_enabled()) {
      unsigned int transitionList[2];
      unsigned int numTransitions=1;
      transitionList[0] = 2;
    ...
    *c1_operation_mode() = 4U;
    _SFD_DATA_RANGE_CHECK((real_T)*c1_operation_mode(), 13U);
     ...
     (int32_T)_SFD_CCP_CALL(12,0,((*c1_async_request() == 6.0)!=0)))) != 0) {
    ...
    *c1_controller_enable() = 0U;
    ...
    switch(chartInstance.c1_is_PRIMITIVE) {
     case c1_IN_MOVING:
      ...
      if(c1__bool_s32_(CV_TRANSITION_EVAL(20U,
         (int32_T)_SFD_CCP_CALL(20,0,((*c1_primitive_button() == 5)!=0)))) != 0)
      {
...
static void c1_CONTROLLER(void)
{
  ...
  if(c1__bool_s32_(CV_TRANSITION_EVAL(13U,
     (int32_T)_SFD_CCP_CALL(13,0,((*c1_async_request() == 1.0)!=0)))) != 0) {
    if(sf_debug_transition_conflict_check_enabled()) {
      unsigned int transitionList[3];
      unsigned int numTransitions=1;
      transitionList[0] = 13;
    ...
    *c1_da_out_trigger() = 1.0;
    _SFD_DATA_RANGE_CHECK(*c1_da_out_trigger(), 6U);
  } else if(c1__bool_s32_(CV_TRANSITION_EVAL(32U,
     (int32_T)_SFD_CCP_CALL(32,0,((*c1_async_request() == 8.0)!=0)))) != 0) {
    if(sf_debug_transition_conflict_check_enabled()) {
      unsigned int transitionList[2];
      unsigned int numTransitions=1;
      transitionList[0] = 32;
    ...
    *c1_operation_mode() = 4U;
    _SFD_DATA_RANGE_CHECK((real_T)*c1_operation_mode(), 13U);
     ...
     (int32_T)_SFD_CCP_CALL(23,0,((*c1_async_request() == 6.0)!=0)))) != 0) {
    ...
    switch(chartInstance.c1_is_CONTROLLER) {
     case c1_IN_HOLD:
      ...
      if(c1__bool_s32_(CV_TRANSITION_EVAL(27U,
         (int32_T)_SFD_CCP_CALL(27,0,((*c1_async_request() == 9.0)!=0)))) != 0) {
        _SFD_CT_CALL(TRANSITION_ACTIVE_TAG,27);
        if(c1__bool_s32_(CV_TRANSITION_EVAL(17U,
           (int32_T)_SFD_CCP_CALL(17,0,((c1_get_invgeo_error(0) == 0)!=0)))) !=
         0) {
      ...
      if(c1__bool_s32_(CV_TRANSITION_EVAL(35U,
         (int32_T)_SFD_CCP_CALL(35,0,((*c1_invgeo_done() == 1)!=0)))) != 0) {
        _SFD_CT_CALL(TRANSITION_ACTIVE_TAG,35);
        if(c1__bool_s32_(CV_TRANSITION_EVAL(14U,
           (int32_T)_SFD_CCP_CALL(14,0,((c1_get_invgeo_error(0) == 0)!=0)))) !=
         0) {
          if(sf_debug_transition_conflict_check_enabled()) {
            unsigned int transitionList[2];
            unsigned int numTransitions=1;
          ...
          *c1_controller_message() = 1U;
          ...
          sf_mex_call("disp", 0U, 1U, 6, (real_T)c1_b_controller_message);
           ...
           (int32_T)_SFD_CCP_CALL(8,0,((c1_get_invgeo_error(0) == 1)!=0)))) !=
         0) {
     ...
     case c1_IN_TRAJECTORY:
      ...
      if(c1__bool_s32_(CV_TRANSITION_EVAL(22U, (_SFD_CCP_CALL(22,0,((_sfEvent_
             == CALL_EVENT)!=0)) != 0) && (_SFD_CCP_CALL(22,1,((
...
static void c1_CONFIG(void)
{
  ...
  if(c1__bool_s32_(CV_TRANSITION_EVAL(31U,
     (int32_T)_SFD_CCP_CALL(31,0,((*c1_async_request() == 1.0)!=0)))) != 0) {
    if(sf_debug_transition_conflict_check_enabled()) {
    ...
    *c1_da_out_trigger() = 1.0;
    _SFD_DATA_RANGE_CHECK(*c1_da_out_trigger(), 6U);
     ...
     (int32_T)_SFD_CCP_CALL(18,0,((*c1_async_request() == 2.0)!=0)))) != 0) {
    if(sf_debug_transition_conflict_check_enabled()) {
    ...
    *c1_operation_mode() = 4U;
    _SFD_DATA_RANGE_CHECK((real_T)*c1_operation_mode(), 13U);
  } else if(c1__bool_s32_(CV_TRANSITION_EVAL(36U,
     (int32_T)_SFD_CCP_CALL(36,0,((*c1_async_request() == 7.0)!=0)))) != 0) {
    if(sf_debug_transition_conflict_check_enabled()) {
      unsigned int transitionList[4];
      unsigned int numTransitions=1;
      transitionList[0] = 36;
    ...
    *c1_operation_mode() = 3U;
    _SFD_DATA_RANGE_CHECK((real_T)*c1_operation_mode(), 13U);
  } else if(c1__bool_s32_(CV_TRANSITION_EVAL(0U,
     (int32_T)_SFD_CCP_CALL(0,0,((*c1_async_request() == 4.0)!=0)))) != 0) {
    if(sf_debug_transition_conflict_check_enabled()) {
      unsigned int transitionList[2];
      unsigned int numTransitions=1;
      transitionList[0] = 0;
...
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(730537858U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(3522753763U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1646563667U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(2403380929U);
}
...
mxArray *sf_c1_MPC_framework_get_autoinheritance_info(void)
{
  ...
  mxCreateStructMatrix(1,1,4,autoinheritanceFields);
  {
    ...
    pr[0] = (double)(1901237089U);
    pr[1] = (double)(517222974U);
    pr[2] = (double)(3189901465U);
    pr[3] = (double)(4067734227U);
    ...
    if(!sim_mode_is_rtw_gen(S)) {
      {
        ...
        if(chartAlreadyPresent==0) {
          ...
          _SFD_SET_DATA_PROPS(21,1,1,0,SF_UINT8,0,NULL,0,0,0,0.0,1.0,0,"init_ack_async",0);
          _SFD_SET_DATA_PROPS(28,2,0,1,SF_UINT8,0,NULL,0,0,0,0.0,1.0,0,"init_out_trigger",0);
          _SFD_SET_DATA_PROPS(20,2,0,1,SF_UINT8,0,NULL,0,0,0,0.0,1.0,0,"stop_trigger",0);
          ...
          _SFD_SET_DATA_PROPS(30,10,0,0,SF_UINT8,0,NULL,1,0,8,0,1,0,"init_1_message",0);
          _SFD_SET_DATA_PROPS(1,10,0,0,SF_UINT8,0,NULL,1,0,8,0,1,0,"init_2_message",0);
          _SFD_SET_DATA_PROPS(24,10,0,0,SF_UINT16,0,NULL,0,0,0,0.0,1.0,0,"motor_positive_value_seg_1",0);
          _SFD_SET_DATA_PROPS(15,10,0,0,SF_UINT16,0,NULL,0,0,0,0.0,1.0,0,"motor_negative_value_seg_1",0);
          ...
          _SFD_SET_DATA_PROPS(14,0,0,0,SF_DOUBLE,0,NULL,0,0,0,0.0,1.0,0,"alpha2_ref",0);
          {
          ...
          _SFD_SET_DATA_PROPS(8,1,1,0,SF_UINT8,0,NULL,0,0,0,0.0,1.0,0,"invgeo_done",0);
          _SFD_SET_DATA_PROPS(31,2,0,1,SF_UINT8,0,NULL,0,0,0,0.0,1.0,0,"trajectory_enable",0);
          _SFD_SET_DATA_PROPS(22,10,0,0,SF_DOUBLE,0,NULL,0,0,0,0.0,1.0,0,"trajectory_time",0);
          _SFD_SET_DATA_PROPS(19,11,0,0,SF_DOUBLE,0,NULL,0,0,0,0.0,1.0,0,"invgeo_alpha_1",0);
          _SFD_SET_DATA_PROPS(23,11,0,0,SF_DOUBLE,0,NULL,0,0,0,0.0,1.0,0,"invgeo_alpha_2",0);
          _SFD_SET_DATA_PROPS(25,10,0,0,SF_DOUBLE,0,NULL,0,0,0,0.0,1.0,0,"ticks_per_trajectory_time",0);
          _SFD_SET_DATA_PROPS(12,10,0,0,SF_UINT16,0,NULL,0,0,0,0.0,1.0,0,"motor_positive_value_seg_2",0);
          ...
          _SFD_ST_SUBSTATE_INDEX(13,0,17);
          _SFD_ST_SUBSTATE_INDEX(13,1,11);
          _SFD_ST_SUBSTATE_INDEX(13,2,4);
          _SFD_ST_SUBSTATE_INDEX(13,3,16);
          _SFD_ST_SUBSTATE_COUNT(17,0);
          _SFD_ST_SUBSTATE_COUNT(11,0);
          _SFD_ST_SUBSTATE_COUNT(4,2);
          _SFD_ST_SUBSTATE_INDEX(4,0,7);
          _SFD_ST_SUBSTATE_INDEX(4,1,9);
          _SFD_ST_SUBSTATE_COUNT(7,1);
          _SFD_ST_SUBSTATE_INDEX(7,0,15);
          _SFD_ST_SUBSTATE_COUNT(15,0);
          _SFD_ST_SUBSTATE_COUNT(9,0);
          _SFD_ST_SUBSTATE_COUNT(16,2);
          _SFD_ST_SUBSTATE_INDEX(16,0,10);
          _SFD_ST_SUBSTATE_INDEX(16,1,6);
          _SFD_ST_SUBSTATE_COUNT(10,2);
          _SFD_ST_SUBSTATE_INDEX(10,0,0);
          _SFD_ST_SUBSTATE_INDEX(10,1,1);
        ...
        {
          _SFD_CV_INIT_STATE(10,2,0,0,0,0,NULL,NULL);
        }
        {
        ...
        }
        {
          ...
          static unsigned int sEndGuardMap[] = {17};
          static int sPostFixPredicateTree[] = {0};
          _SFD_CV_INIT_TRANS(36,1,&(sStartGuardMap[0]),&(sEndGuardMap[0]),1,&(sPostFixPredicateTree[0]));
        }
        {
          static unsigned int sStartGuardMap[] = {1};
          static unsigned int sEndGuardMap[] = {17};
        ...
        _SFD_SET_DATA_VALUE_PTR(21U, c1_init_ack_async());
        _SFD_SET_DATA_VALUE_PTR(28U, c1_init_out_trigger());
        _SFD_SET_DATA_VALUE_PTR(20U, c1_stop_trigger());
        ...
        _SFD_SET_DATA_VALUE_PTR(30U, &chartInstance.c1_init_1_message);
        _SFD_SET_DATA_VALUE_PTR(1U, &chartInstance.c1_init_2_message);
        ...
        _SFD_SET_DATA_VALUE_PTR(14U, &chartInstance.c1_alpha2_ref);
        ...
        _SFD_SET_DATA_VALUE_PTR(8U, c1_invgeo_done());
        _SFD_SET_DATA_VALUE_PTR(31U, c1_trajectory_enable());
        _SFD_SET_DATA_VALUE_PTR(22U, &chartInstance.c1_trajectory_time);
        _SFD_SET_DATA_VALUE_PTR(19U, chartInstance.c1_invgeo_alpha_1_address);
        _SFD_SET_DATA_VALUE_PTR(23U, chartInstance.c1_invgeo_alpha_2_address);
...
static void mdlSetWorkWidths_c1_MPC_framework(SimStruct *S)
{
  ...
  ssSetChecksum0(S,(4206857053U));
  ssSetChecksum1(S,(406802797U));
  ssSetChecksum2(S,(2607166696U));
  ssSetChecksum3(S,(1048430967U));
