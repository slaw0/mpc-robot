 ...
 plhs[], int nrhs, const mxArray * prhs[] )
{
  ...
  if(nrhs>1 && mxIsChar(prhs[1])) {
    ...
    ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(681581177U);
    ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(1483691466U);
    ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2741835618U);
    ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(256670534U);
  }
  return 1;
#else
  return 0;
