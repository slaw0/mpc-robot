...
static SFc4_controller_test_2006aInstanceStruct chartInstance;

/* Function Declarations */
static void initialize_c4_controller_test_2006a(void);
static void initialize_params_c4_controller_test_2006a(void);
static void enable_c4_controller_test_2006a(void);
static void disable_c4_controller_test_2006a(void);
static void finalize_c4_controller_test_2006a(void);
static void sf_c4_controller_test_2006a(void);
...
static void sf_save_state_c4_controller_test_2006a(FILE *c4_file);
static void sf_load_state_c4_controller_test_2006a(FILE *c4_file);

/* Function Definitions */
static void initialize_c4_controller_test_2006a(void)
{
  _sfTime_ = (real_T)ssGetT(chartInstance.S);
  chartInstance.c4_is_active_c4_controller_test_2006a = 0U;
}
...
static void sf_save_state_c4_controller_test_2006a(FILE *c4_file)
{
  fwrite(&chartInstance.c4_is_active_c4_controller_test_2006a, 1,
   sizeof(chartInstance.c4_is_active_c4_controller_test_2006a), c4_file
   );
}

static void sf_load_state_c4_controller_test_2006a(FILE *c4_file)
{
  fread(&chartInstance.c4_is_active_c4_controller_test_2006a, 1,
   sizeof(chartInstance.c4_is_active_c4_controller_test_2006a), c4_file);
}

/* SFunction Glue Code */
void sf_c4_controller_test_2006a_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(4100691314U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2978260701U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(2790134202U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1960169260U);
}

mxArray *sf_c4_controller_test_2006a_get_autoinheritance_info(void)
{
...
static void sf_opaque_initialize_c4_controller_test_2006a(void *chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S);
  initialize_params_c4_controller_test_2006a();
  initialize_c4_controller_test_2006a();
}

static void sf_opaque_enable_c4_controller_test_2006a(void *chartInstanceVar)
{
  enable_c4_controller_test_2006a();
}

static void sf_opaque_disable_c4_controller_test_2006a(void *chartInstanceVar)
{
  disable_c4_controller_test_2006a();
}

static void sf_opaque_gateway_c4_controller_test_2006a(void *chartInstanceVar)
{
  sf_c4_controller_test_2006a();
}

static void sf_opaque_terminate_c4_controller_test_2006a(void *chartInstanceVar)
{
  finalize_c4_controller_test_2006a();
}

static void mdlProcessParameters_c4_controller_test_2006a(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c4_controller_test_2006a(SimStruct *S)
{
  if(sim_mode_is_rtw_gen(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("controller_test_2006a",4);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop("controller_test_2006a",4,"gatewayCannotBeInlinedMultipleTimes"));
    if(chartIsInlinable) {
      ...
      sf_mark_chart_expressionable_inputs(S,"controller_test_2006a",4,8);
      sf_mark_chart_reusable_outputs(S,"controller_test_2006a",4,3);
    }
    if (!sf_is_chart_instance_optimized_out("controller_test_2006a",4)) {
      int dtId;
      char *chartInstanceTypedefName =
        sf_chart_instance_typedef_name("controller_test_2006a",4);
...
static void mdlRTW_c4_controller_test_2006a(SimStruct *S)
{
  if(sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "controller_test_2006a", 4);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void
sf_save_debug_c4_controller_test_2006a(SFc4_controller_test_2006aInstanceStruct*
...
static void
sf_load_debug_c4_controller_test_2006a(SFc4_controller_test_2006aInstanceStruct*
 chartInstance,FILE* file)
{
  int machineNumber = _controller_test_2006aMachineNumber_;
  int chartNumber = chartInstance->chartNumber;
...
static void sf_c4_controller_test_2006a_sim_ctx_io(SimStruct* S, const char io,
 FILE* file)
{
  if(io == 'r') {
    sf_load_state_c4_controller_test_2006a(file);
    sf_load_debug_c4_controller_test_2006a(&chartInstance, file);
  } else {
    sf_save_state_c4_controller_test_2006a(file);
    sf_save_debug_c4_controller_test_2006a(&chartInstance, file);
  }
}
static void mdlStart_c4_controller_test_2006a(SimStruct *S)
{
  chartInstance.chartInfo.chartInstance = NULL;
  chartInstance.chartInfo.isEMLChart = 1;
  chartInstance.chartInfo.chartInitialized = 0;
  chartInstance.chartInfo.sFunctionGateway =
    sf_opaque_gateway_c4_controller_test_2006a;
  chartInstance.chartInfo.initializeChart =
    sf_opaque_initialize_c4_controller_test_2006a;
  chartInstance.chartInfo.terminateChart =
    sf_opaque_terminate_c4_controller_test_2006a;
  chartInstance.chartInfo.enableChart =
    sf_opaque_enable_c4_controller_test_2006a;
  chartInstance.chartInfo.disableChart =
    sf_opaque_disable_c4_controller_test_2006a;
  chartInstance.chartInfo.mdlRTW = mdlRTW_c4_controller_test_2006a;
  chartInstance.chartInfo.mdlStart = mdlStart_c4_controller_test_2006a;
  chartInstance.chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c4_controller_test_2006a;
  chartInstance.chartInfo.restoreLastMajorStepConfiguration = NULL;
  chartInstance.chartInfo.restoreBeforeLastMajorStepConfiguration = NULL;
  chartInstance.chartInfo.storeCurrentConfiguration = NULL;
  chartInstance.S = S;
  ssSetUserData(S,(void *)(&(chartInstance.chartInfo))); /* register the chart instance with simstruct */
  ssSetmdlSimulationContextIO(S, sf_c4_controller_test_2006a_sim_ctx_io);
  if(!sim_mode_is_rtw_gen(S)) {
    init_dsm_address_info();
  }
}

void c4_controller_test_2006a_method_dispatcher(SimStruct *S, int_T method, void
 *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c4_controller_test_2006a(S);
    break;
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c4_controller_test_2006a(S);
    break;
   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c4_controller_test_2006a(S);
    break;
   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
     "Error calling c4_controller_test_2006a_method_dispatcher.\n"
