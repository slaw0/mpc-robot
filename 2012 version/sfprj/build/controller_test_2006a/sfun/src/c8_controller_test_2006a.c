...
static SFc8_controller_test_2006aInstanceStruct chartInstance;

/* Function Declarations */
static void initialize_c8_controller_test_2006a(void);
static void initialize_params_c8_controller_test_2006a(void);
static void enable_c8_controller_test_2006a(void);
static void disable_c8_controller_test_2006a(void);
static void finalize_c8_controller_test_2006a(void);
static void sf_c8_controller_test_2006a(void);
static real_T c8_mpower(real_T c8_a);
static real_T c8_b_mpower(real_T c8_a);
static real_T c8_c_mpower(real_T c8_a);
static void c8_inv(real_T *c8_x, real_T *c8_y);
static real_T c8_norm(real_T *c8_x);
static real_T *c8_A(void);
static real_T *c8_B(void);
static real_T *c8_t(void);
static real_T *c8_a0(void);
static real_T *c8_a1(void);
static real_T *c8_a2(void);
static real_T *c8_a3(void);
static real_T *c8_a4(void);
static real_T *c8_a5(void);
static void init_dsm_address_info(void);
static void sf_save_state_c8_controller_test_2006a(FILE *c8_file);
static void sf_load_state_c8_controller_test_2006a(FILE *c8_file);

/* Function Definitions */
static void initialize_c8_controller_test_2006a(void)
{
  _sfTime_ = (real_T)ssGetT(chartInstance.S);
  chartInstance.c8_is_active_c8_controller_test_2006a = 0U;
}
...
static void sf_c8_controller_test_2006a(void)
{
  ...
  int32_T c8_em_i7;
  real_T c8_b_T[6][6];
  real_T c8_em_dv4[6][6];
  real_T c8_j_B[6];
  int32_T c8_em_i8;
  int32_T c8_em_i9;
  _sfTime_ = (real_T)ssGetT(chartInstance.S);
  _SFD_DATA_RANGE_CHECK(*c8_A(), 8U);
  _SFD_DATA_RANGE_CHECK(*c8_B(), 1U);
  _SFD_DATA_RANGE_CHECK(*c8_t(), 4U);
  _SFD_DATA_RANGE_CHECK(*c8_a0(), 2U);
  _SFD_DATA_RANGE_CHECK(*c8_a1(), 7U);
  _SFD_DATA_RANGE_CHECK(*c8_a2(), 5U);
  _SFD_DATA_RANGE_CHECK(*c8_a3(), 3U);
  _SFD_DATA_RANGE_CHECK(*c8_a4(), 6U);
  _SFD_DATA_RANGE_CHECK(*c8_a5(), 0U);
  ...
  for(c8_em_i6 = 0; c8_em_i6 < 6; c8_em_i6 = c8_em_i6 + 1) {
    for(c8_em_i7 = 0; c8_em_i7 < 6; c8_em_i7 = c8_em_i7 + 1) {
      c8_b_T[c8_em_i6][c8_em_i7] = c8_T[c8_em_i6][c8_em_i7];
    }
  }
  c8_inv((real_T *)c8_b_T, (real_T *)c8_em_dv4);
  c8_j_B[0] = c8_b_B;
  c8_j_B[1] = 0.0;
  c8_j_B[2] = 0.0;
  c8_j_B[3] = c8_b_A;
  ...
  for(c8_em_i8 = 0; c8_em_i8 < 6; c8_em_i8 = c8_em_i8 + 1) {
    ...
    for(c8_em_i9 = 0; c8_em_i9 < 6; c8_em_i9 = c8_em_i9 + 1) {
      c8_Ao[c8_em_i8] = c8_Ao[c8_em_i8] + c8_em_dv4[c8_em_i9][c8_em_i8] *
        c8_j_B[c8_em_i9];
    }
  }
...
static void c8_inv(real_T *c8_x, real_T *c8_y)
{
  ...
  for(c8_em_i10 = 0; c8_em_i10 < 6; c8_em_i10 = c8_em_i10 + 1) {
    for(c8_em_i11 = 0; c8_em_i11 < 6; c8_em_i11 = c8_em_i11 + 1) {
      c8_b_x[c8_em_i10][c8_em_i11] = c8_x[6 * c8_em_i10 + c8_em_i11];
      c8_b_y[c8_em_i10][c8_em_i11] = 0.0;
      c8_b_A[c8_em_i10][c8_em_i11] = c8_b_x[c8_em_i10][c8_em_i11];
      c8_c_A[c8_em_i10][c8_em_i11] = c8_b_A[c8_em_i10][c8_em_i11];
    }
  }
  for(c8_em_i12 = 0; c8_em_i12 < 6; c8_em_i12 = c8_em_i12 + 1) {
    c8_pivot[c8_em_i12][0] = 1.0 + (real_T)c8_em_i12;
  }
  for(c8_k = 1.0; c8_k <= 5.0; c8_k = c8_k + 1.0) {
    ...
    for(c8_i = c8_em_d0; c8_i <= 6.0; c8_i = c8_i + 1.0) {
      ...
      c8_d_y = fabs(c8_d_x);
      if(c8_d_y > c8_maxval) {
        c8_e_x = c8_c_A[(int32_T)_SFD_EML_ARRAY_BOUNDS_CHECK("A",
         (int32_T)_SFD_INTEGER_CHECK("k", c8_b_k), 1, 6, 2) - 1][(int32_T)
  ...
  if(c8_c_k <= 6.0) {
    ...
    for(c8_e_k = 1.0; c8_e_k <= 6.0; c8_e_k = c8_e_k + 1.0) {
      ...
      c8_b_y[(int32_T)_SFD_EML_ARRAY_BOUNDS_CHECK("y",
       (int32_T)_SFD_INTEGER_CHECK("c", c8_c), 1, 6, 2) - 1][(int32_T)
      _SFD_EML_ARRAY_BOUNDS_CHECK("y", (int32_T)_SFD_INTEGER_CHECK("k", c8_d_k),
       1, 6, 1) - 1] = 1.0;
      c8_em_d4 = c8_d_k;
      for(c8_c_j = c8_em_d4; c8_c_j <= 6.0; c8_c_j = c8_c_j + 1.0) {
        c8_d_j = c8_c_j;
        if(c8_b_y[(int32_T)_SFD_EML_ARRAY_BOUNDS_CHECK("y",
          (int32_T)_SFD_INTEGER_CHECK("c", c8_c), 1, 6, 2) - 1][(int32_T)
         _SFD_EML_ARRAY_BOUNDS_CHECK("y", (int32_T)_SFD_INTEGER_CHECK("j",
          ...
          for(c8_e_i = c8_em_d5; c8_e_i <= 6.0; c8_e_i = c8_e_i + 1.0) {
            ...
            c8_b_y[(int32_T)_SFD_EML_ARRAY_BOUNDS_CHECK("y", (int32_T)
             _SFD_INTEGER_CHECK("c", c8_c), 1, 6, 2) -
            1][(int32_T)_SFD_EML_ARRAY_BOUNDS_CHECK("y",
             (int32_T)_SFD_INTEGER_CHECK("j", c8_d_j), 1,
             6, 1) - 1] * c8_b_x[(int32_T)_SFD_EML_ARRAY_BOUNDS_CHECK("x",
      ...
      for(c8_e_j = 6.0; c8_e_j >= 1.0; c8_e_j = c8_e_j + -1.0) {
        c8_d_j = c8_e_j;
        c8_e_A = c8_b_y[(int32_T)_SFD_EML_ARRAY_BOUNDS_CHECK("y",
         (int32_T)_SFD_INTEGER_CHECK("c", c8_c), 1, 6, 2) - 1][(int32_T)
        _SFD_EML_ARRAY_BOUNDS_CHECK("y", (int32_T)_SFD_INTEGER_CHECK("j",
          c8_d_j), 1, 6, 1) - 1];
        c8_c_B = c8_b_x[(int32_T)_SFD_EML_ARRAY_BOUNDS_CHECK("x",
         (int32_T)_SFD_INTEGER_CHECK("j", c8_d_j), 1, 6, 2) - 1][(int32_T)
        _SFD_EML_ARRAY_BOUNDS_CHECK("x", (int32_T)_SFD_INTEGER_CHECK("j",
          c8_d_j), 1, 6, 1) - 1];
        c8_i_x = c8_e_A;
        c8_i_y = c8_c_B;
        c8_b_z = c8_i_x / c8_i_y;
        c8_j_y = c8_b_z;
        c8_b_y[(int32_T)_SFD_EML_ARRAY_BOUNDS_CHECK("y",
         (int32_T)_SFD_INTEGER_CHECK("c", c8_c), 1, 6, 2) - 1][(int32_T)
        _SFD_EML_ARRAY_BOUNDS_CHECK("y", (int32_T)_SFD_INTEGER_CHECK("j",
          c8_d_j), 1, 6, 1) - 1] = c8_j_y;
        if(c8_b_y[(int32_T)_SFD_EML_ARRAY_BOUNDS_CHECK("y",
          (int32_T)_SFD_INTEGER_CHECK("c", c8_c), 1, 6, 2) - 1][(int32_T)
         _SFD_EML_ARRAY_BOUNDS_CHECK("y", (int32_T)_SFD_INTEGER_CHECK("j",
           c8_d_j), 1, 6, 1) - 1] != 0.0) {
  ...
  c8_h_y = rtInf;
  for(c8_em_i18 = 0; c8_em_i18 < 36; c8_em_i18 = c8_em_i18 + 1) {
    (*(real_T (*)[36])&c8_b_y)[c8_em_i18] = c8_h_y;
  }
  label_2:;
  for(c8_em_i19 = 0; c8_em_i19 < 6; c8_em_i19 = c8_em_i19 + 1) {
    for(c8_em_i20 = 0; c8_em_i20 < 6; c8_em_i20 = c8_em_i20 + 1) {
      c8_y[6 * c8_em_i19 + c8_em_i20] = c8_b_y[c8_em_i19][c8_em_i20];
      c8_j_x[c8_em_i19][c8_em_i20] = c8_x[6 * c8_em_i19 + c8_em_i20];
      c8_xinv[c8_em_i19][c8_em_i20] = c8_y[6 * c8_em_i19 + c8_em_i20];
    }
  }
  c8_f_A = 1.0;
  for(c8_em_i21 = 0; c8_em_i21 < 6; c8_em_i21 = c8_em_i21 + 1) {
    for(c8_em_i22 = 0; c8_em_i22 < 6; c8_em_i22 = c8_em_i22 + 1) {
      c8_k_x[c8_em_i21][c8_em_i22] = c8_j_x[c8_em_i21][c8_em_i22];
      c8_b_xinv[c8_em_i21][c8_em_i22] = c8_xinv[c8_em_i21][c8_em_i22];
    }
  }
  c8_d_B = c8_norm((real_T *)c8_k_x) * c8_norm((real_T *)c8_b_xinv);
  c8_l_x = c8_f_A;
  c8_k_y = c8_d_B;
  c8_c_z = c8_l_x / c8_k_y;
  c8_l_y = c8_c_z;
  c8_rcond = c8_l_y;
  if(c8_rcond == 0.0) {
    ...
    for(c8_em_i23 = 0; c8_em_i23 < 103; c8_em_i23 = c8_em_i23 + 1) {
      c8_em_cv1[c8_em_i23][0] = c8_em_cv0[c8_em_i23][0];
    }
...
static real_T c8_norm(real_T *c8_x)
{
  ...
  for(c8_em_i24 = 0; c8_em_i24 < 6; c8_em_i24 = c8_em_i24 + 1) {
    for(c8_em_i25 = 0; c8_em_i25 < 6; c8_em_i25 = c8_em_i25 + 1) {
      c8_b_x[c8_em_i24][c8_em_i25] = c8_x[6 * c8_em_i24 + c8_em_i25];
    }
  }
  c8_zero = 0.0;
  c8_b_y = c8_zero;
...
static void sf_save_state_c8_controller_test_2006a(FILE *c8_file)
{
  fwrite(&chartInstance.c8_is_active_c8_controller_test_2006a, 1,
   sizeof(chartInstance.c8_is_active_c8_controller_test_2006a), c8_file
   );
}

static void sf_load_state_c8_controller_test_2006a(FILE *c8_file)
{
  fread(&chartInstance.c8_is_active_c8_controller_test_2006a, 1,
   sizeof(chartInstance.c8_is_active_c8_controller_test_2006a), c8_file);
}

/* SFunction Glue Code */
void sf_c8_controller_test_2006a_get_check_sum(mxArray *plhs[])
{
  ((real_T *)mxGetPr((plhs[0])))[0] = (real_T)(1024468541U);
  ((real_T *)mxGetPr((plhs[0])))[1] = (real_T)(2735298676U);
  ((real_T *)mxGetPr((plhs[0])))[2] = (real_T)(1330163414U);
  ((real_T *)mxGetPr((plhs[0])))[3] = (real_T)(1922115969U);
}

mxArray *sf_c8_controller_test_2006a_get_autoinheritance_info(void)
{
    ...
    if(!sim_mode_is_rtw_gen(S)) {
      {
        ...
        _SFD_SET_DATA_VALUE_PTR(8U, c8_A());
        _SFD_SET_DATA_VALUE_PTR(1U, c8_B());
        _SFD_SET_DATA_VALUE_PTR(4U, c8_t());
        _SFD_SET_DATA_VALUE_PTR(2U, c8_a0());
        _SFD_SET_DATA_VALUE_PTR(7U, c8_a1());
        _SFD_SET_DATA_VALUE_PTR(5U, c8_a2());
        _SFD_SET_DATA_VALUE_PTR(3U, c8_a3());
        _SFD_SET_DATA_VALUE_PTR(6U, c8_a4());
        _SFD_SET_DATA_VALUE_PTR(0U, c8_a5());
      }
    }
  } else {
...
static void sf_opaque_initialize_c8_controller_test_2006a(void *chartInstanceVar)
{
  chart_debug_initialization(chartInstance.S);
  initialize_params_c8_controller_test_2006a();
  initialize_c8_controller_test_2006a();
}

static void sf_opaque_enable_c8_controller_test_2006a(void *chartInstanceVar)
{
  enable_c8_controller_test_2006a();
}

static void sf_opaque_disable_c8_controller_test_2006a(void *chartInstanceVar)
{
  disable_c8_controller_test_2006a();
}

static void sf_opaque_gateway_c8_controller_test_2006a(void *chartInstanceVar)
{
  sf_c8_controller_test_2006a();
}

static void sf_opaque_terminate_c8_controller_test_2006a(void *chartInstanceVar)
{
  finalize_c8_controller_test_2006a();
}

static void mdlProcessParameters_c8_controller_test_2006a(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c8_controller_test_2006a(SimStruct *S)
{
  if(sim_mode_is_rtw_gen(S)) {
    int_T chartIsInlinable =
      (int_T)sf_is_chart_inlinable("controller_test_2006a",8);
    ssSetStateflowIsInlinable(S,chartIsInlinable);
    ssSetEnableFcnIsTrivial(S,1);
    ssSetDisableFcnIsTrivial(S,1);
    ssSetNotMultipleInlinable(S,sf_rtw_info_uint_prop("controller_test_2006a",8,"gatewayCannotBeInlinedMultipleTimes"));
    if(chartIsInlinable) {
      ssSetInputPortOptimOpts(S, 0, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 1, SS_REUSABLE_AND_LOCAL);
      ssSetInputPortOptimOpts(S, 2, SS_REUSABLE_AND_LOCAL);
      sf_mark_chart_expressionable_inputs(S,"controller_test_2006a",8,3);
      sf_mark_chart_reusable_outputs(S,"controller_test_2006a",8,6);
    }
    if (!sf_is_chart_instance_optimized_out("controller_test_2006a",8)) {
      int dtId;
      char *chartInstanceTypedefName =
        sf_chart_instance_typedef_name("controller_test_2006a",8);
...
static void mdlRTW_c8_controller_test_2006a(SimStruct *S)
{
  if(sim_mode_is_rtw_gen(S)) {
    sf_write_symbol_mapping(S, "controller_test_2006a", 8);
    ssWriteRTWStrParam(S, "StateflowChartType", "Embedded MATLAB");
  }
}

static void
sf_save_debug_c8_controller_test_2006a(SFc8_controller_test_2006aInstanceStruct*
...
static void
sf_load_debug_c8_controller_test_2006a(SFc8_controller_test_2006aInstanceStruct*
 chartInstance,FILE* file)
{
  int machineNumber = _controller_test_2006aMachineNumber_;
  int chartNumber = chartInstance->chartNumber;
...
static void sf_c8_controller_test_2006a_sim_ctx_io(SimStruct* S, const char io,
 FILE* file)
{
  if(io == 'r') {
    sf_load_state_c8_controller_test_2006a(file);
    sf_load_debug_c8_controller_test_2006a(&chartInstance, file);
  } else {
    sf_save_state_c8_controller_test_2006a(file);
    sf_save_debug_c8_controller_test_2006a(&chartInstance, file);
  }
}
static void mdlStart_c8_controller_test_2006a(SimStruct *S)
{
  chartInstance.chartInfo.chartInstance = NULL;
  chartInstance.chartInfo.isEMLChart = 1;
  chartInstance.chartInfo.chartInitialized = 0;
  chartInstance.chartInfo.sFunctionGateway =
    sf_opaque_gateway_c8_controller_test_2006a;
  chartInstance.chartInfo.initializeChart =
    sf_opaque_initialize_c8_controller_test_2006a;
  chartInstance.chartInfo.terminateChart =
    sf_opaque_terminate_c8_controller_test_2006a;
  chartInstance.chartInfo.enableChart =
    sf_opaque_enable_c8_controller_test_2006a;
  chartInstance.chartInfo.disableChart =
    sf_opaque_disable_c8_controller_test_2006a;
  chartInstance.chartInfo.mdlRTW = mdlRTW_c8_controller_test_2006a;
  chartInstance.chartInfo.mdlStart = mdlStart_c8_controller_test_2006a;
  chartInstance.chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c8_controller_test_2006a;
  chartInstance.chartInfo.restoreLastMajorStepConfiguration = NULL;
  chartInstance.chartInfo.restoreBeforeLastMajorStepConfiguration = NULL;
  chartInstance.chartInfo.storeCurrentConfiguration = NULL;
  chartInstance.S = S;
  ssSetUserData(S,(void *)(&(chartInstance.chartInfo))); /* register the chart instance with simstruct */
  ssSetmdlSimulationContextIO(S, sf_c8_controller_test_2006a_sim_ctx_io);
  if(!sim_mode_is_rtw_gen(S)) {
    init_dsm_address_info();
  }
}

void c8_controller_test_2006a_method_dispatcher(SimStruct *S, int_T method, void
 *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c8_controller_test_2006a(S);
    break;
   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c8_controller_test_2006a(S);
    break;
   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c8_controller_test_2006a(S);
    break;
   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
     "Error calling c8_controller_test_2006a_method_dispatcher.\n"
