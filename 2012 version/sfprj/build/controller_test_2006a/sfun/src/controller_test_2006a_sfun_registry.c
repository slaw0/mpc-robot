...
unsigned int sf_process_check_sum_call( int nlhs, mxArray * plhs[], int nrhs,
 const mxArray * prhs[] )
{
  extern unsigned int sf_controller_test_2006a_process_check_sum_call( int nlhs,
   mxArray * plhs[], int nrhs, const mxArray * prhs[] );

  if(sf_controller_test_2006a_process_check_sum_call(nlhs,plhs,nrhs,prhs))
  return 1;
  return 0;
}
...
{
  extern unsigned int sf_controller_test_2006a_autoinheritance_info( int nlhs,
   mxArray * plhs[], int nrhs, const mxArray * prhs[] );
  if(sf_controller_test_2006a_autoinheritance_info(nlhs,plhs,nrhs,prhs)) return
  1;
  return 0;
}
...
extern unsigned int sf_controller_test_2006a_method_dispatcher(SimStruct *S,
...
{
  if(sf_controller_test_2006a_method_dispatcher(simstructPtr,chartName,method,data))
  return 1;
  return 0;
}
extern void controller_test_2006a_terminator(void);
void sf_machine_global_terminator(void)
{
  if(sfMachineGlobalTerminatorCallable) {
    ...
    controller_test_2006a_terminator();
    sf_debug_terminate();
  }
  return;
}
extern void controller_test_2006a_initializer(void);
extern void controller_test_2006a_register_exported_symbols(SimStruct* S);
extern void controller_test_2006a_debug_initialize(void);
void sf_register_machine_exported_symbols(SimStruct* S)
{
  controller_test_2006a_register_exported_symbols(S);
}
void sf_machine_global_initializer(SimStruct* S)
{
  ...
  if(sfMachineGlobalInitializerCallable) {
    ...
    if(!simModeIsRTWGen) {
      controller_test_2006a_debug_initialize();
    }
    controller_test_2006a_initializer();
  }
  return;
}
