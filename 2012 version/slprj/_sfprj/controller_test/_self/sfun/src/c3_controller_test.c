...
static void initialize_c3_controller_test(SFc3_controller_testInstanceStruct
  *chartInstance);
static void initialize_params_c3_controller_test
  (SFc3_controller_testInstanceStruct *chartInstance);
static void enable_c3_controller_test(SFc3_controller_testInstanceStruct
  *chartInstance);
static void disable_c3_controller_test(SFc3_controller_testInstanceStruct
  *chartInstance);
static void c3_update_debugger_state_c3_controller_test
  (SFc3_controller_testInstanceStruct *chartInstance);
static const mxArray *get_sim_state_c3_controller_test
  (SFc3_controller_testInstanceStruct *chartInstance);
static void set_sim_state_c3_controller_test(SFc3_controller_testInstanceStruct *
  chartInstance, const mxArray *c3_st);
static void finalize_c3_controller_test(SFc3_controller_testInstanceStruct
  *chartInstance);
static void sf_c3_controller_test(SFc3_controller_testInstanceStruct
  *chartInstance);
static void c3_chartstep_c3_controller_test(SFc3_controller_testInstanceStruct
  *chartInstance);
static void initSimStructsc3_controller_test(SFc3_controller_testInstanceStruct *
  chartInstance);
static void init_script_number_translation(uint32_T c3_machineNumber, uint32_T
  c3_chartNumber);
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData);
static real_T c3_emlrt_marshallIn(SFc3_controller_testInstanceStruct
  *chartInstance, const mxArray *c3_qapp, const char_T *c3_identifier);
static real_T c3_b_emlrt_marshallIn(SFc3_controller_testInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static const mxArray *c3_b_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static void c3_c_emlrt_marshallIn(SFc3_controller_testInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId,
  real_T c3_y[3]);
...
static const mxArray *c3_c_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static void c3_d_emlrt_marshallIn(SFc3_controller_testInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId,
  real_T c3_y[18]);
static void c3_c_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static void c3_info_helper(c3_ResolvedFunctionInfo c3_info[16]);
static void c3_eml_scalar_eg(SFc3_controller_testInstanceStruct *chartInstance);
static real_T c3_mpower(SFc3_controller_testInstanceStruct *chartInstance,
  real_T c3_a);
static real_T c3_b_mpower(SFc3_controller_testInstanceStruct *chartInstance,
  real_T c3_a);
static real_T c3_c_mpower(SFc3_controller_testInstanceStruct *chartInstance,
  real_T c3_a);
static void c3_b_eml_scalar_eg(SFc3_controller_testInstanceStruct *chartInstance);
static const mxArray *c3_d_sf_marshallOut(void *chartInstanceVoid, void
  *c3_inData);
static int32_T c3_e_emlrt_marshallIn(SFc3_controller_testInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void c3_d_sf_marshallIn(void *chartInstanceVoid, const mxArray
  *c3_mxArrayInData, const char_T *c3_varName, void *c3_outData);
static uint8_T c3_f_emlrt_marshallIn(SFc3_controller_testInstanceStruct
  *chartInstance, const mxArray *c3_b_is_active_c3_controller_test, const char_T
  *c3_identifier);
static uint8_T c3_g_emlrt_marshallIn(SFc3_controller_testInstanceStruct
  *chartInstance, const mxArray *c3_u, const emlrtMsgIdentifier *c3_parentId);
static void init_dsm_address_info(SFc3_controller_testInstanceStruct
  *chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c3_is_active_c3_controller_test = 0U;
}
  ...
  (SFc3_controller_testInstanceStruct *chartInstance)
{
  ...
  c3_d_hoistedGlobal = chartInstance->c3_is_active_c3_controller_test;
  ...
  chartInstance, const mxArray *c3_st)
{
  ...
  *c3_qapp = c3_emlrt_marshallIn(chartInstance, sf_mex_dup(sf_mex_getcell(c3_u,
    2)), "qapp");
  chartInstance->c3_is_active_c3_controller_test = c3_f_emlrt_marshallIn
    (chartInstance, sf_mex_dup(sf_mex_getcell(c3_u, 3)),
     "is_active_c3_controller_test");
  sf_mex_destroy(&c3_u);
  c3_update_debugger_state_c3_controller_test(chartInstance);
  ...
  *chartInstance)
{
  ...
  chartInstance->c3_sfEvent = CALL_EVENT;
  c3_chartstep_c3_controller_test(chartInstance);
...
static const mxArray *c3_sf_marshallOut(void *chartInstanceVoid, void *c3_inData)
{
  ...
  const mxArray *c3_y = NULL;
  SFc3_controller_testInstanceStruct *chartInstance;
  chartInstance = (SFc3_controller_testInstanceStruct *)chartInstanceVoid;
...
const mxArray *sf_c3_controller_test_get_eml_resolved_functions_info(void)
{
  ...
  *c3_identifier)
{
  ...
  c3_y = c3_g_emlrt_marshallIn(chartInstance, sf_mex_dup
    (c3_b_is_active_c3_controller_test), &c3_thisId);
  sf_mex_destroy(&c3_b_is_active_c3_controller_test);
  return c3_y;
}
...
/* SFunction Glue Code */
void sf_c3_controller_test_get_check_sum(mxArray *plhs[])
{
...
mxArray *sf_c3_controller_test_get_autoinheritance_info(void)
{
...
static const mxArray *sf_get_sim_state_info_c3_controller_test(void)
{
  const char *infoFields[] = { "chartChecksum", "varInfo" };

  mxArray *mxInfo = mxCreateStructMatrix(1, 1, 2, infoFields);
  const char *infoEncStr[] = {
    "100 S1x4'type','srcId','name','auxInfo'{{M[1],M[11],T\"qa\",},{M[1],M[12],T\"qap\",},{M[1],M[13],T\"qapp\",},{M[8],M[0],T\"is_active_c3_controller_test\",}}"
  };

  mxArray *mxVarInfo = sf_mex_decode_encoded_mx_struct_array(infoEncStr, 4, 10);
  mxArray *mxChecksum = mxCreateDoubleMatrix(1, 4, mxREAL);
  sf_c3_controller_test_get_check_sum(&mxChecksum);
  ...
  fullDebuggerInitialization)
{
  if (!sim_mode_is_rtw_gen(S)) {
    SFc3_controller_testInstanceStruct *chartInstance;
    chartInstance = (SFc3_controller_testInstanceStruct *) ((ChartInfoStruct *)
...
static void sf_opaque_initialize_c3_controller_test(void *chartInstanceVar)
{
  chart_debug_initialization(((SFc3_controller_testInstanceStruct*)
    chartInstanceVar)->S,0);
  initialize_params_c3_controller_test((SFc3_controller_testInstanceStruct*)
    chartInstanceVar);
  initialize_c3_controller_test((SFc3_controller_testInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_enable_c3_controller_test(void *chartInstanceVar)
{
  enable_c3_controller_test((SFc3_controller_testInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_disable_c3_controller_test(void *chartInstanceVar)
{
  disable_c3_controller_test((SFc3_controller_testInstanceStruct*)
    chartInstanceVar);
}

static void sf_opaque_gateway_c3_controller_test(void *chartInstanceVar)
{
  sf_c3_controller_test((SFc3_controller_testInstanceStruct*) chartInstanceVar);
}

extern const mxArray* sf_internal_get_sim_state_c3_controller_test(SimStruct* S)
{
  ...
  prhs[2] = (mxArray*) get_sim_state_c3_controller_test
    ((SFc3_controller_testInstanceStruct*)chartInfo->chartInstance);/* raw sim ctx */
  prhs[3] = (mxArray*) sf_get_sim_state_info_c3_controller_test();/* state var info */
...
extern void sf_internal_set_sim_state_c3_controller_test(SimStruct* S, const
  mxArray *st)
{
  ChartInfoStruct *chartInfo = (ChartInfoStruct*) ssGetUserData(S);
  mxArray *plhs[1] = { NULL };
  ...
  set_sim_state_c3_controller_test((SFc3_controller_testInstanceStruct*)
    chartInfo->chartInstance, mxDuplicateArray(plhs[0]));
  mxDestroyArray(plhs[0]);
}

static const mxArray* sf_opaque_get_sim_state_c3_controller_test(SimStruct* S)
{
  return sf_internal_get_sim_state_c3_controller_test(S);
}

static void sf_opaque_set_sim_state_c3_controller_test(SimStruct* S, const
  mxArray *st)
{
  sf_internal_set_sim_state_c3_controller_test(S, st);
}

static void sf_opaque_terminate_c3_controller_test(void *chartInstanceVar)
{
  if (chartInstanceVar!=NULL) {
    SimStruct *S = ((SFc3_controller_testInstanceStruct*) chartInstanceVar)->S;
    if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
      sf_clear_rtw_identifier(S);
    }

    finalize_c3_controller_test((SFc3_controller_testInstanceStruct*)
      chartInstanceVar);
...
{
  initSimStructsc3_controller_test((SFc3_controller_testInstanceStruct*)
    chartInstanceVar);
}

extern unsigned int sf_machine_global_initializer_called(void);
static void mdlProcessParameters_c3_controller_test(SimStruct *S)
{
  int i;
...
static void mdlSetWorkWidths_c3_controller_test(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S) || sim_mode_is_external(S)) {
...
static void mdlRTW_c3_controller_test(SimStruct *S)
{
  if (sim_mode_is_rtw_gen(S)) {
...
static void mdlStart_c3_controller_test(SimStruct *S)
{
  SFc3_controller_testInstanceStruct *chartInstance;
  chartInstance = (SFc3_controller_testInstanceStruct *)malloc(sizeof
    (SFc3_controller_testInstanceStruct));
  memset(chartInstance, 0, sizeof(SFc3_controller_testInstanceStruct));
  ...
  chartInstance->chartInfo.sFunctionGateway =
    sf_opaque_gateway_c3_controller_test;
  chartInstance->chartInfo.initializeChart =
    sf_opaque_initialize_c3_controller_test;
  chartInstance->chartInfo.terminateChart =
    sf_opaque_terminate_c3_controller_test;
  chartInstance->chartInfo.enableChart = sf_opaque_enable_c3_controller_test;
  chartInstance->chartInfo.disableChart = sf_opaque_disable_c3_controller_test;
  chartInstance->chartInfo.getSimState =
    sf_opaque_get_sim_state_c3_controller_test;
  chartInstance->chartInfo.setSimState =
    sf_opaque_set_sim_state_c3_controller_test;
  chartInstance->chartInfo.getSimStateInfo =
    sf_get_sim_state_info_c3_controller_test;
  chartInstance->chartInfo.zeroCrossings = NULL;
  chartInstance->chartInfo.outputs = NULL;
  chartInstance->chartInfo.derivatives = NULL;
  chartInstance->chartInfo.mdlRTW = mdlRTW_c3_controller_test;
  chartInstance->chartInfo.mdlStart = mdlStart_c3_controller_test;
  chartInstance->chartInfo.mdlSetWorkWidths =
    mdlSetWorkWidths_c3_controller_test;
...
void c3_controller_test_method_dispatcher(SimStruct *S, int_T method, void *data)
{
  switch (method) {
   case SS_CALL_MDL_START:
    mdlStart_c3_controller_test(S);
    break;

   case SS_CALL_MDL_SET_WORK_WIDTHS:
    mdlSetWorkWidths_c3_controller_test(S);
    break;

   case SS_CALL_MDL_PROCESS_PARAMETERS:
    mdlProcessParameters_c3_controller_test(S);
    break;

   default:
    /* Unhandled method */
    sf_mex_error_message("Stateflow Internal Error:\n"
                         "Error calling c3_controller_test_method_dispatcher.\n"
