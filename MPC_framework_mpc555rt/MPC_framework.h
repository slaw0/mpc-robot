...
typedef struct {
  real32_T qa;                          /* '<S48>/Joint reference singal 1' */
} rtB_Jointreferencesingal;

/* Block signals for system '<S49>/Trajectory design 1' */
typedef struct {
  real32_T a0;                          /* '<S49>/Trajectory design 1' */
  real32_T a1;                          /* '<S49>/Trajectory design 1' */
  real32_T a2;                          /* '<S49>/Trajectory design 1' */
  real32_T a3;                          /* '<S49>/Trajectory design 1' */
  real32_T a4;                          /* '<S49>/Trajectory design 1' */
  real32_T a5;                          /* '<S49>/Trajectory design 1' */
} rtB_MP_Trajectorydesign1;

/* Block signals (auto storage) */
typedef struct {
  CAN_FRAME Datarealtime;               /* '<S74>/CAN Receive (S-Function)' */
  CAN_FRAME Datarealtime_p;             /* '<S75>/CAN Receive (S-Function)' */
  CAN_FRAME Datarealtime_b;             /* '<S93>/CAN Receive (S-Function)' */
  CAN_FRAME Datarealtime_pd;            /* '<S54>/CAN Receive (S-Function)' */
  CAN_FRAME Datarealtime_pr;            /* '<S63>/CAN Receive (S-Function)' */
  CAN_FRAME Datarealtime_l;             /* '<S82>/CAN Receive (S-Function)' */
  ...
  real_T CANMessageUnpackingCANdb_o;    /* '<S64>/CAN Message Unpacking (CANdb)' */
  real_T CANMessageUnpackingCANdb_c;    /* '<S64>/CAN Message Unpacking (CANdb)' */
  real32_T Gain4;                       /* '<S12>/Gain4' */
  real32_T Gain5;                       /* '<S12>/Gain5' */
  real32_T CANMessageUnpackingCANdb_d; /* '<S83>/CAN Message Unpacking (CANdb)' */
  real32_T CANMessageUnpackingCANdb_g; /* '<S83>/CAN Message Unpacking (CANdb)' */
  real32_T CANMessageUnpackingCANdb_dc; /* '<S55>/CAN Message Unpacking (CANdb)' */
  real32_T TmpHiddenBufferAtSFunctionInp[2]; /* '<Root>/State Machine' */
  real32_T motor1_reference;            /* '<Root>/State Machine' */
  real32_T motor2_reference;            /* '<Root>/State Machine' */
  real32_T controller_enable;           /* '<Root>/State Machine' */
  real32_T da_out_trigger;              /* '<Root>/State Machine' */
  real32_T al1;                         /* '<S45>/invgeo' */
  real32_T al2;                         /* '<S45>/invgeo' */
  real32_T Saturation1;                 /* '<S3>/Saturation1' */
  real32_T Saturation2;                 /* '<S3>/Saturation2' */
  real32_T Sum2;                        /* '<S2>/Sum2' */
  real32_T Sum3;                        /* '<S2>/Sum3' */
  uint16_T DataTypeConversion;          /* '<S13>/Data Type Conversion' */
  uint16_T DataTypeConversion1;         /* '<S13>/Data Type Conversion1' */
  uint16_T Saturation;                  /* '<S3>/Saturation' */
...
typedef struct {
  ...
  real32_T UnitDelay_DSTATE_e;          /* '<S24>/Unit Delay' */
  real32_T UnitDelay_DSTATE_o;          /* '<S27>/Unit Delay' */
  real32_T UnitDelay_DSTATE_i;          /* '<S26>/Unit Delay' */
  real32_T DelayInput1_DSTATE;          /* '<S43>/Delay Input1' */
  real32_T DelayInput1_DSTATE_i;        /* '<S44>/Delay Input1' */
  real32_T invgeo_alpha_1;              /* '<Root>/invgeo_alpha_1' */
  real32_T invgeo_alpha_2;              /* '<Root>/invgeo_alpha_2' */
  ...
  uint8_T UnitDelay_DSTATE_g;           /* '<S47>/Unit Delay' */
  uint8_T UnitDelay1_DSTATE;            /* '<S47>/Unit Delay1' */
...
struct _Parameters_MPC_framework {
  ...
  real_T Constant_Value_h;              /* Computed Parameter: Value
                                         * '<S77>/Constant'
                                         */
  real32_T Gain_Gain;                   /* Computed Parameter: Gain
                                         * '<S12>/Gain'
                                         */
  real32_T Gain4_Gain;                  /* Computed Parameter: Gain
                                         * '<S12>/Gain4'
                                         */
  real32_T Gain1_Gain;                  /* Computed Parameter: Gain
                                         * '<S12>/Gain1'
                                         */
  real32_T Gain5_Gain;                  /* Computed Parameter: Gain
                                         * '<S12>/Gain5'
                                         */
  real32_T Switch_Threshold;            /* Computed Parameter: Threshold
                                         * '<Root>/Switch'
                                         */
  real32_T Gain2_Gain;                  /* Computed Parameter: Gain
                                         * '<S12>/Gain2'
                                         */
  real32_T Gain3_Gain;                  /* Computed Parameter: Gain
                                         * '<S12>/Gain3'
                                         */
  real32_T invgeo_alpha_1_InitialValu; /* Computed Parameter: InitialValue
                                        * '<Root>/invgeo_alpha_1'
                                        */
  real32_T invgeo_alpha_2_InitialValu; /* Computed Parameter: InitialValue
                                        * '<Root>/invgeo_alpha_2'
                                        */
  real32_T Ap1_Value;                   /* Computed Parameter: Value
                                         * '<S2>/Ap1'
                                         */
  real32_T Ap2_Value;                   /* Computed Parameter: Value
                                         * '<S2>/Ap2'
                                         */
  real32_T T_Value;                     /* Computed Parameter: Value
                                         * '<S2>/T'
                                         */
  real32_T UnitDelay_X0;                /* Computed Parameter: X0
                                         * '<S25>/Unit Delay'
                                         */
  real32_T Tc1_Value;                   /* Computed Parameter: Value
                                         * '<S2>/Tc1'
                                         */
  real32_T UnitDelay_X0_b;              /* Computed Parameter: X0
                                         * '<S24>/Unit Delay'
                                         */
  real32_T Td1_Value;                   /* Computed Parameter: Value
                                         * '<S2>/Td1'
                                         */
  real32_T Saturation_UpperSat;         /* Computed Parameter: UpperLimit
                                         * '<S22>/Saturation'
                                         */
  real32_T Saturation_LowerSat;         /* Computed Parameter: LowerLimit
                                         * '<S22>/Saturation'
                                         */
  real32_T Saturation1_UpperSat;        /* Computed Parameter: UpperLimit
                                         * '<S22>/Saturation1'
                                         */
  real32_T Saturation1_LowerSat;        /* Computed Parameter: LowerLimit
                                         * '<S22>/Saturation1'
                                         */
  real32_T UnitDelay_X0_a;              /* Computed Parameter: X0
                                         * '<S27>/Unit Delay'
                                         */
  real32_T Tc2_Value;                   /* Computed Parameter: Value
                                         * '<S2>/Tc2'
                                         */
  real32_T UnitDelay_X0_o;              /* Computed Parameter: X0
                                         * '<S26>/Unit Delay'
                                         */
  real32_T Td2_Value;                   /* Computed Parameter: Value
                                         * '<S2>/Td2'
                                         */
  real32_T Saturation_UpperSat_i;       /* Computed Parameter: UpperLimit
                                         * '<S23>/Saturation'
                                         */
  real32_T Saturation_LowerSat_b;       /* Computed Parameter: LowerLimit
                                         * '<S23>/Saturation'
                                         */
  real32_T Saturation1_UpperSat_i;      /* Computed Parameter: UpperLimit
                                         * '<S23>/Saturation1'
                                         */
  real32_T Saturation1_LowerSat_j;      /* Computed Parameter: LowerLimit
                                         * '<S23>/Saturation1'
                                         */
  real32_T Gain_Gain_b;                 /* Computed Parameter: Gain
                                         * '<S2>/Gain'
                                         */
  real32_T Gain2_Gain_p;                /* Computed Parameter: Gain
                                         * '<S2>/Gain2'
                                         */
  real32_T Gain1_Gain_k;                /* Computed Parameter: Gain
                                         * '<S2>/Gain1'
                                         */
  real32_T c1_Value;                    /* Computed Parameter: Value
                                         * '<S2>/c1'
                                         */
  real32_T c2_Value;                    /* Computed Parameter: Value
                                         * '<S2>/c2'
                                         */
  real32_T Saturation1_UpperSat_a;      /* Computed Parameter: UpperLimit
                                         * '<S3>/Saturation1'
                                         */
  real32_T Saturation1_LowerSat_m;      /* Computed Parameter: LowerLimit
                                         * '<S3>/Saturation1'
                                         */
  real32_T Saturation2_UpperSat;        /* Computed Parameter: UpperLimit
                                         * '<S3>/Saturation2'
                                         */
  real32_T Saturation2_LowerSat;        /* Computed Parameter: LowerLimit
                                         * '<S3>/Saturation2'
                                         */
  real32_T a1_Value;                    /* Expression: a1
                                         * '<S6>/a1'
                                         */
  real32_T a2_Value;                    /* Expression: a2
                                         * '<S6>/a2'
                                         */
  real32_T DelayInput1_X0;              /* Computed Parameter: X0
                                         * '<S43>/Delay Input1'
                                         */
  real32_T DelayInput1_X0_b;            /* Computed Parameter: X0
                                         * '<S44>/Delay Input1'
                                         */
  real32_T SFunction_p8;                /* Computed Parameter: p8
                                         * '<Root>/State Machine'
                                         */
  real32_T SFunction_p9;                /* Computed Parameter: p9
                                         * '<Root>/State Machine'
                                         */
  int32_T Constant_Value_g;             /* Expression: incntr_half_val
                                         * '<S12>/Constant'
                                         */
  int32_T Gain12_Gain;                  /* Computed Parameter: Gain
                                         * '<S12>/Gain12'
                                         */
  uint16_T Constant_Value_i;            /* Expression: motor_stopped_value
                                         * '<S3>/Constant'
                                         */
  uint16_T Saturation_UpperSat_n;       /* Expression: DA_max_saturation
                                         * '<S3>/Saturation'
                                         */
  uint16_T Saturation_LowerSat_i;       /* Expression: DA_min_saturation
                                         * '<S3>/Saturation'
                                         */
  ...
  uint16_T SFunction_p7;                /* Expression: motor_stopped_value
                                         * '<Root>/State Machine'
                                         */
  uint8_T UnitDelay_X0_ov;              /* Computed Parameter: X0
                                         * '<S47>/Unit Delay'
                                         */
  uint8_T UnitDelay1_X0;                /* Computed Parameter: X0
                                         * '<S47>/Unit Delay1'
                                         */
