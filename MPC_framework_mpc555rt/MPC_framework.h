...
typedef struct {
  ...
  uint16_T motor1_reference;            /* '<S7>/motor1_reference' */
  uint16_T motor2_reference;            /* '<S7>/motor2_reference' */
  uint16_T motor1_reference_p;          /* '<Root>/State Machine' */
  uint16_T motor2_reference_n;          /* '<Root>/State Machine' */
...
typedef struct {
  ...
  int_T Trajectoryandcontrol_MODE;      /* '<Root>/Trajectory and control' */
 ...
 * '<S7>'   : MPC_framework/Trajectory and control
