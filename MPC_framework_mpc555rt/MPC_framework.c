    ...
    switch(MPC_framework_DWork.StateMachine.is_PRIMITIVE) {
     case MPC_framework_IN_MOVING:
      if(MPC_framework_B.CANMessageUnpackingCANdb_l == 5) {
        ...
        MPC_framework_B.motor1_reference_p = MPC_framework_P.SFunction_p5;
        MPC_framework_B.motor2_reference_n = MPC_framework_P.SFunction_p5;
        ...
        switch(MPC_framework_DWork.StateMachine.is_SEGMENT_1) {
         ...
         default:
          ...
          MPC_framework_B.motor1_reference_p = MPC_framework_P.SFunction_p4;
          MPC_framework_B.da_out_trigger = 1.0;
          break;
        }
        switch(MPC_framework_DWork.StateMachine.is_SEGMENT_2) {
         ...
         default:
          MPC_framework_DWork.StateMachine.is_SEGMENT_2 =
            (uint8_T)MPC_framework_IN_POSITIVE_MOV;
          MPC_framework_B.motor2_reference_n = MPC_framework_P.SFunction_p4;
          MPC_framework_B.da_out_trigger = 1.0;
          break;
        }
      }
     ...
     case MPC_framework_IN_STOPPED:
      if(MPC_framework_B.CANMessageUnpackingCANdb_l == 4) {
        ...
        MPC_framework_B.motor2_reference_n = MPC_framework_P.SFunction_p3;
        MPC_framework_B.da_out_trigger = 1.0;
        ...
        MPC_framework_DWork.StateMachine.is_SEGMENT_1 =
          (uint8_T)MPC_framework_IN_NEGATIVE_MOV;
        MPC_framework_B.motor1_reference_p = MPC_framework_P.SFunction_p3;
        MPC_framework_DWork.StateMachine.is_active_SEGMENT_2 = 1U;
        MPC_framework_DWork.StateMachine.is_SEGMENT_2 =
          (uint8_T)MPC_framework_IN_POSITIVE_MOV;
        MPC_framework_B.motor2_reference_n = MPC_framework_P.SFunction_p4;
...
void MPC_frame_StateMachine_Init(void)
{
  ...
  MPC_framework_B.stop_trigger = 0U;
  MPC_framework_B.motor1_reference_p = 32768U;
  MPC_framework_B.motor2_reference_n = 32768U;
  MPC_framework_B.controller_enable = 0U;
  MPC_framework_B.da_out_trigger = 0.0;
...
void MPC_framework_step0(void)          /* Sample time: [0.01s, 0.0s] */
{
  ...
  /* Outputs for enable SubSystem: '<Root>/Trajectory and control' */
  if(0.0 > 0.0) {
    MPC_framework_DWork.Trajectoryandcontrol_MODE = SUBSYS_ENABLED;
  } else if(MPC_framework_DWork.Trajectoryandcontrol_MODE == SUBSYS_ENABLED) {

    MPC_framework_DWork.Trajectoryandcontrol_MODE = SUBSYS_DISABLED;
  }
  if(MPC_framework_DWork.Trajectoryandcontrol_MODE == SUBSYS_ENABLED) {

    /* Inport: '<S7>/motor1_reference' */
    MPC_framework_B.motor1_reference = MPC_framework_B.motor1_reference_p;

    /* Inport: '<S7>/motor2_reference' */
    MPC_framework_B.motor2_reference = MPC_framework_B.motor2_reference_n;
  }

  /* end of Outputs for SubSystem: '<Root>/Trajectory and control' */
  ...
  if(MPC_framework_B.controller_enable > MPC_framework_P.Switch_Threshold) {
    ...
    MPC_framework_B.Switch[0] = MPC_framework_B.motor1_reference_p;
    MPC_framework_B.Switch[1] = MPC_framework_B.motor2_reference_n;
  }
